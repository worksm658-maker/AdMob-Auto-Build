...
.method private constructor <init>(Ljava/util/List;IIIIIIIIIFLjava/lang/String;)V
    ...
    .line 178
    iput p5, p0, Lio/bidmachine/media3/extractor/AvcConfig;->bitdepthLuma:I

    .line 179
    iput p6, p0, Lio/bidmachine/media3/extractor/AvcConfig;->bitdepthChroma:I

    .line 180
    iput p7, p0, Lio/bidmachine/media3/extractor/AvcConfig;->colorSpace:I

    .line 181
    iput p8, p0, Lio/bidmachine/media3/extractor/AvcConfig;->colorRange:I

    .line 182
    iput p9, p0, Lio/bidmachine/media3/extractor/AvcConfig;->colorTransfer:I

    .line 183
    iput p10, p0, Lio/bidmachine/media3/extractor/AvcConfig;->maxNumReorderFrames:I

    .line 184
    iput p11, p0, Lio/bidmachine/media3/extractor/AvcConfig;->pixelWidthHeightRatio:F

    .line 185
    iput-object p12, p0, Lio/bidmachine/media3/extractor/AvcConfig;->codecs:Ljava/lang/String;
...
.method public static parse(Lio/bidmachine/media3/common/util/ParsableByteArray;)Lio/bidmachine/media3/extractor/AvcConfig;
    ...
    .line 73
    invoke-static {v0, v1, p0}, Lio/bidmachine/media3/container/NalUnitUtil;->parseSpsNalUnit([BII)Lio/bidmachine/media3/container/NalUnitUtil$SpsData;
    ...
    .line 77
    iget v2, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->bitDepthLumaMinus8:I

    add-int/lit8 v2, v2, 0x8

    .line 78
    iget v5, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->bitDepthChromaMinus8:I

    add-int/lit8 v5, v5, 0x8

    .line 79
    iget v6, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->colorSpace:I

    .line 80
    iget v7, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->colorRange:I

    .line 81
    iget v8, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->colorTransfer:I

    .line 82
    iget v9, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->maxNumReorderFrames:I

    .line 83
    iget v10, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->pixelWidthHeightRatio:F

    .line 84
    iget v11, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->profileIdc:I

    iget v12, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->constraintsFlagsAndReservedZero2Bits:I

    iget p0, p0, Lio/bidmachine/media3/container/NalUnitUtil$SpsData;->levelIdc:I

    .line 85
    invoke-static {v11, v12, p0}, Lio/bidmachine/media3/common/util/CodecSpecificDataUtil;->buildAvcCodecString(III)Ljava/lang/String;
    ...
    invoke-direct/range {v2 .. v14}, Lio/bidmachine/media3/extractor/AvcConfig;-><init>(Ljava/util/List;IIIIIIIIIFLjava/lang/String;)V
