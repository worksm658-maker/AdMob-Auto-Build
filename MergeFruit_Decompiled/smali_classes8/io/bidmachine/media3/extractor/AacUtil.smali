.class public final Lio/bidmachine/media3/extractor/AacUtil;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/bidmachine/media3/extractor/AacUtil$Config;,
        Lio/bidmachine/media3/extractor/AacUtil$AacAudioObjectType;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/bidmachine/media3/extractor/AacUtil;->AUDIO_SPECIFIC_CONFIG_SAMPLING_RATE_TABLE:[I
    ...
    sput-object v0, Lio/bidmachine/media3/extractor/AacUtil;->AUDIO_SPECIFIC_CONFIG_CHANNEL_COUNT_TABLE:[I
...
.method public static buildAacLcAudioSpecificConfig(II)[B
    ...
    .line 285
    :goto_0
    sget-object v4, Lio/bidmachine/media3/extractor/AacUtil;->AUDIO_SPECIFIC_CONFIG_SAMPLING_RATE_TABLE:[I
    ...
    .line 291
    :goto_1
    sget-object v4, Lio/bidmachine/media3/extractor/AacUtil;->AUDIO_SPECIFIC_CONFIG_CHANNEL_COUNT_TABLE:[I
    ...
    .line 300
    invoke-static {p0, v3, v2}, Lio/bidmachine/media3/extractor/AacUtil;->buildAudioSpecificConfig(III)[B
...
.method private static getAudioObjectType(Lio/bidmachine/media3/common/util/ParsableBitArray;)I
    .locals 2
...
.method private static getSamplingFrequency(Lio/bidmachine/media3/common/util/ParsableBitArray;)I
    .locals 3
    ...
    .line 351
    sget-object p0, Lio/bidmachine/media3/extractor/AacUtil;->AUDIO_SPECIFIC_CONFIG_SAMPLING_RATE_TABLE:[I
...
.method public static parseAudioSpecificConfig(Lio/bidmachine/media3/common/util/ParsableBitArray;Z)Lio/bidmachine/media3/extractor/AacUtil$Config;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lio/bidmachine/media3/common/ParserException;
    ...
    .line 212
    invoke-static {p0}, Lio/bidmachine/media3/extractor/AacUtil;->getAudioObjectType(Lio/bidmachine/media3/common/util/ParsableBitArray;)I

    move-result v0

    .line 213
    invoke-static {p0}, Lio/bidmachine/media3/extractor/AacUtil;->getSamplingFrequency(Lio/bidmachine/media3/common/util/ParsableBitArray;)I
    ...
    :cond_2
    :pswitch_0
    invoke-static {p0, v0, v3}, Lio/bidmachine/media3/extractor/AacUtil;->parseGaSpecificConfig(Lio/bidmachine/media3/common/util/ParsableBitArray;II)V
    ...
    :cond_4
    :goto_0
    sget-object p0, Lio/bidmachine/media3/extractor/AacUtil;->AUDIO_SPECIFIC_CONFIG_CHANNEL_COUNT_TABLE:[I
    ...
    .line 273
    new-instance p1, Lio/bidmachine/media3/extractor/AacUtil$Config;

    invoke-direct {p1, v1, p0, v4, v0}, Lio/bidmachine/media3/extractor/AacUtil$Config;-><init>(IILjava/lang/String;Lio/bidmachine/media3/extractor/AacUtil$1;)V
...
.method public static parseAudioSpecificConfig([B)Lio/bidmachine/media3/extractor/AacUtil$Config;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lio/bidmachine/media3/common/ParserException;
    ...
    invoke-static {v0, p0}, Lio/bidmachine/media3/extractor/AacUtil;->parseAudioSpecificConfig(Lio/bidmachine/media3/common/util/ParsableBitArray;Z)Lio/bidmachine/media3/extractor/AacUtil$Config;
...
.method private static parseGaSpecificConfig(Lio/bidmachine/media3/common/util/ParsableBitArray;II)V
    .locals 3
