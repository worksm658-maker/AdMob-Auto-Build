...
.method protected constructor <init>()V
    ...
    .line 2099
    iput v0, p0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->bitsPerChannel:I
...
.method public initializeOutput(Lio/bidmachine/media3/extractor/ExtractorOutput;I)V
    ...
    invoke-static {v1, v11}, Lio/bidmachine/media3/common/ParserException;->createForMalformedContainer(Ljava/lang/String;Ljava/lang/Throwable;)Lio/bidmachine/media3/common/ParserException;
    ...
    iget-wide v6, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->codecDelayNs:J
    ...
    iget-wide v6, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->seekPreRollNs:J
    ...
    .line 2185
    iget-object v3, v1, Lio/bidmachine/media3/extractor/HevcConfig;->initializationData:Ljava/util/List;

    .line 2186
    iget v4, v1, Lio/bidmachine/media3/extractor/HevcConfig;->nalUnitLengthFieldLength:I

    iput v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->nalUnitLengthFieldLength:I
    ...
    iget v3, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->audioBitDepth:I
    ...
    invoke-static {v12, v1}, Lio/bidmachine/media3/common/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 2218
    iget-object v3, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->codecPrivate:[B
    ...
    .line 2221
    iget v4, v3, Lio/bidmachine/media3/extractor/AacUtil$Config;->sampleRateHz:I

    iput v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->sampleRate:I

    .line 2222
    iget v4, v3, Lio/bidmachine/media3/extractor/AacUtil$Config;->channelCount:I

    iput v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->channelCount:I

    .line 2223
    iget-object v3, v3, Lio/bidmachine/media3/extractor/AacUtil$Config;->codecs:Ljava/lang/String;
    ...
    .line 2178
    iget-object v3, v1, Lio/bidmachine/media3/extractor/AvcConfig;->initializationData:Ljava/util/List;

    .line 2179
    iget v4, v1, Lio/bidmachine/media3/extractor/AvcConfig;->nalUnitLengthFieldLength:I
    ...
    .line 2352
    :goto_12
    iget-object v7, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->dolbyVisionConfigBytes:[B
    ...
    iget-object v8, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->dolbyVisionConfigBytes:[B

    invoke-direct {v7, v8}, Lio/bidmachine/media3/common/util/ParsableByteArray;-><init>([B)V

    .line 2355
    invoke-static {v7}, Lio/bidmachine/media3/extractor/DolbyVisionConfig;->parse(Lio/bidmachine/media3/common/util/ParsableByteArray;)Lio/bidmachine/media3/extractor/DolbyVisionConfig;
    ...
    .line 2357
    iget-object v3, v7, Lio/bidmachine/media3/extractor/DolbyVisionConfig;->codecs:Ljava/lang/String;
    ...
    .line 2363
    iget-boolean v8, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->flagDefault:Z

    .line 2364
    iget-boolean v12, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->flagForced:Z
    ...
    .line 2367
    new-instance v12, Lio/bidmachine/media3/common/Format$Builder;

    invoke-direct {v12}, Lio/bidmachine/media3/common/Format$Builder;-><init>()V
    ...
    .line 2372
    iget v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->channelCount:I

    .line 2373
    invoke-virtual {v12, v2}, Lio/bidmachine/media3/common/Format$Builder;->setChannelCount(I)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    iget v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->sampleRate:I

    .line 2374
    invoke-virtual {v2, v4}, Lio/bidmachine/media3/common/Format$Builder;->setSampleRate(I)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    .line 2375
    invoke-virtual {v2, v9}, Lio/bidmachine/media3/common/Format$Builder;->setPcmEncoding(I)Lio/bidmachine/media3/common/Format$Builder;
    ...
    .line 2378
    iget v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->displayUnit:I

    if-nez v2, :cond_31

    .line 2379
    iget v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->displayWidth:I

    const/4 v5, -0x1

    if-ne v2, v5, :cond_2f

    iget v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->width:I

    :cond_2f
    iput v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->displayWidth:I

    .line 2380
    iget v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->displayHeight:I

    if-ne v2, v5, :cond_30

    iget v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->height:I

    :cond_30
    iput v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->displayHeight:I
    ...
    iget v9, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->displayHeight:I

    if-eq v9, v5, :cond_32

    .line 2384
    iget v10, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->height:I

    mul-int/2addr v10, v2

    int-to-float v2, v10

    iget v10, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->width:I
    ...
    .line 2387
    :goto_15
    iget-boolean v9, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->hasColorInfo:Z
    ...
    .line 2389
    new-instance v10, Lio/bidmachine/media3/common/ColorInfo$Builder;

    invoke-direct {v10}, Lio/bidmachine/media3/common/ColorInfo$Builder;-><init>()V

    iget v11, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->colorSpace:I

    .line 2391
    invoke-virtual {v10, v11}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorSpace(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object v10

    iget v11, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->colorRange:I

    .line 2392
    invoke-virtual {v10, v11}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorRange(I)Lio/bidmachine/media3/common/ColorInfo$Builder;
    ...
    .line 2393
    invoke-virtual {v10, v11}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorTransfer(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object v10

    .line 2394
    invoke-virtual {v10, v9}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setHdrStaticInfo([B)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object v9

    iget v10, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->bitsPerChannel:I

    .line 2395
    invoke-virtual {v9, v10}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setLumaBitdepth(I)Lio/bidmachine/media3/common/ColorInfo$Builder;
    ...
    .line 2396
    invoke-virtual {v9, v10}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setChromaBitdepth(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object v9

    .line 2397
    invoke-virtual {v9}, Lio/bidmachine/media3/common/ColorInfo$Builder;->build()Lio/bidmachine/media3/common/ColorInfo;
    ...
    iget-object v10, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->name:Ljava/lang/String;
    ...
    .line 2404
    :cond_34
    iget v9, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->projectionType:I

    if-nez v9, :cond_39

    iget v9, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->projectionPoseYaw:F
    ...
    iget v9, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->projectionPosePitch:F
    ...
    .line 2408
    iget v9, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->projectionPoseRoll:F
    ...
    .line 2410
    :cond_35
    iget v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->projectionPoseRoll:F
    ...
    .line 2419
    :goto_17
    iget v5, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->width:I

    .line 2420
    invoke-virtual {v12, v5}, Lio/bidmachine/media3/common/Format$Builder;->setWidth(I)Lio/bidmachine/media3/common/Format$Builder;
    ...
    .line 2421
    invoke-virtual {v5, v9}, Lio/bidmachine/media3/common/Format$Builder;->setHeight(I)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v5

    .line 2422
    invoke-virtual {v5, v2}, Lio/bidmachine/media3/common/Format$Builder;->setPixelWidthHeightRatio(F)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    .line 2423
    invoke-virtual {v2, v4}, Lio/bidmachine/media3/common/Format$Builder;->setRotationDegrees(I)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    iget-object v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->projectionData:[B

    .line 2424
    invoke-virtual {v2, v4}, Lio/bidmachine/media3/common/Format$Builder;->setProjectionData([B)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    iget v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->stereoMode:I

    .line 2425
    invoke-virtual {v2, v4}, Lio/bidmachine/media3/common/Format$Builder;->setStereoMode(I)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    .line 2426
    invoke-virtual {v2, v11}, Lio/bidmachine/media3/common/Format$Builder;->setColorInfo(Lio/bidmachine/media3/common/ColorInfo;)Lio/bidmachine/media3/common/Format$Builder;
    ...
    .line 2439
    :goto_19
    iget-object v2, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->name:Ljava/lang/String;
    ...
    iget-object v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->name:Ljava/lang/String;
    ...
    invoke-virtual {v12, v2}, Lio/bidmachine/media3/common/Format$Builder;->setLabel(Ljava/lang/String;)Lio/bidmachine/media3/common/Format$Builder;

    :cond_3d
    move/from16 v2, p2

    .line 2445
    invoke-virtual {v12, v2}, Lio/bidmachine/media3/common/Format$Builder;->setId(I)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    .line 2446
    iget-boolean v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->isWebm:Z
    ...
    :goto_1a
    invoke-virtual {v2, v4}, Lio/bidmachine/media3/common/Format$Builder;->setContainerMimeType(Ljava/lang/String;)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    .line 2447
    invoke-virtual {v2, v7}, Lio/bidmachine/media3/common/Format$Builder;->setSampleMimeType(Ljava/lang/String;)Lio/bidmachine/media3/common/Format$Builder;
    ...
    iget-object v4, v0, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor$Track;->language:Ljava/lang/String;
    ...
    .line 2450
    invoke-virtual {v2, v8}, Lio/bidmachine/media3/common/Format$Builder;->setSelectionFlags(I)Lio/bidmachine/media3/common/Format$Builder;

    move-result-object v2

    .line 2451
    invoke-virtual {v2, v1}, Lio/bidmachine/media3/common/Format$Builder;->setInitializationData(Ljava/util/List;)Lio/bidmachine/media3/common/Format$Builder;
    ...
    invoke-interface {v3, v2, v5}, Lio/bidmachine/media3/extractor/ExtractorOutput;->track(II)Lio/bidmachine/media3/extractor/TrackOutput;
