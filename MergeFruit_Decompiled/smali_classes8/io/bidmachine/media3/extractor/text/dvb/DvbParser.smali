.class public final Lio/bidmachine/media3/extractor/text/dvb/DvbParser;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object v2, p0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->defaultPaint:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->fillRegionPaint:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->canvas:Landroid/graphics/Canvas;

    .line 126
    new-instance v3, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;
    ...
    invoke-direct/range {v3 .. v9}, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;-><init>(IIIIII)V

    iput-object v3, p0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->defaultDisplayDefinition:Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;

    .line 127
    new-instance v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$ClutDefinition;
    ...
    invoke-direct {v2, v1, v3, v4, v5}, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$ClutDefinition;-><init>(I[I[I[I)V

    iput-object v2, p0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->defaultClutDefinition:Lio/bidmachine/media3/extractor/text/dvb/DvbParser$ClutDefinition;

    .line 133
    new-instance v1, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$SubtitleService;

    invoke-direct {v1, p1, v0}, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$SubtitleService;-><init>(II)V

    iput-object v1, p0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->subtitleService:Lio/bidmachine/media3/extractor/text/dvb/DvbParser$SubtitleService;
...
.method private parse(Lio/bidmachine/media3/common/util/ParsableBitArray;)Lio/bidmachine/media3/extractor/text/CuesWithTiming;
    .locals 18
    ...
    iget-object v1, v1, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$SubtitleService;->pageComposition:Lio/bidmachine/media3/extractor/text/dvb/DvbParser$PageComposition;

    if-nez v1, :cond_1

    .line 167
    new-instance v2, Lio/bidmachine/media3/extractor/text/CuesWithTiming;
    ...
    invoke-direct/range {v2 .. v7}, Lio/bidmachine/media3/extractor/text/CuesWithTiming;-><init>(Ljava/util/List;JJ)V
    ...
    iget-object v2, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$SubtitleService;->displayDefinition:Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;
    ...
    .line 175
    :cond_2
    iget-object v2, v0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->defaultDisplayDefinition:Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;
    ...
    iget v3, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->width:I
    ...
    iget v3, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->height:I
    ...
    iget v4, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->height:I
    ...
    .line 187
    iget-object v1, v1, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$PageComposition;->regions:Landroid/util/SparseArray;
    ...
    .line 190
    iget-object v5, v0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->canvas:Landroid/graphics/Canvas;
    ...
    check-cast v5, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$PageRegion;
    ...
    .line 196
    iget v8, v5, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$PageRegion;->horizontalAddress:I

    iget v9, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->horizontalPositionMinimum:I

    add-int/2addr v8, v9

    .line 198
    iget v5, v5, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$PageRegion;->verticalAddress:I

    iget v9, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->verticalPositionMinimum:I
    ...
    iget v10, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->horizontalPositionMaximum:I
    ...
    iget v11, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->verticalPositionMaximum:I
    ...
    iget v3, v13, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionObject;->horizontalPosition:I
    ...
    iget-object v1, v0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->canvas:Landroid/graphics/Canvas;
    ...
    .line 238
    iget-boolean v1, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->fillFlag:Z

    if-eqz v1, :cond_c

    .line 240
    iget v1, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->depth:I
    ...
    .line 241
    iget-object v1, v11, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$ClutDefinition;->clutEntries8Bit:[I

    iget v3, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->pixelCode8Bit:I
    ...
    .line 243
    iget-object v1, v11, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$ClutDefinition;->clutEntries4Bit:[I

    iget v3, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->pixelCode4Bit:I
    ...
    .line 245
    :cond_b
    iget-object v1, v11, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$ClutDefinition;->clutEntries2Bit:[I

    iget v3, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->pixelCode2Bit:I

    aget v1, v1, v3

    .line 247
    :goto_6
    iget-object v3, v0, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->fillRegionPaint:Landroid/graphics/Paint;
    ...
    iget v1, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->width:I

    add-int/2addr v1, v8

    int-to-float v12, v1

    iget v1, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->height:I
    ...
    .line 258
    invoke-virtual {v1, v3}, Lio/bidmachine/media3/common/text/Cue$Builder;->setBitmap(Landroid/graphics/Bitmap;)Lio/bidmachine/media3/common/text/Cue$Builder;

    move-result-object v1

    int-to-float v3, v8

    iget v8, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->width:I
    ...
    .line 265
    invoke-virtual {v1, v3}, Lio/bidmachine/media3/common/text/Cue$Builder;->setPosition(F)Lio/bidmachine/media3/common/text/Cue$Builder;
    ...
    .line 266
    invoke-virtual {v1, v3}, Lio/bidmachine/media3/common/text/Cue$Builder;->setPositionAnchor(I)Lio/bidmachine/media3/common/text/Cue$Builder;

    move-result-object v1

    int-to-float v5, v5

    iget v8, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->height:I
    ...
    .line 267
    invoke-virtual {v1, v5, v3}, Lio/bidmachine/media3/common/text/Cue$Builder;->setLine(FI)Lio/bidmachine/media3/common/text/Cue$Builder;

    move-result-object v1

    .line 269
    invoke-virtual {v1, v3}, Lio/bidmachine/media3/common/text/Cue$Builder;->setLineAnchor(I)Lio/bidmachine/media3/common/text/Cue$Builder;

    move-result-object v1

    iget v3, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->width:I

    int-to-float v3, v3

    iget v5, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->width:I
    ...
    .line 270
    invoke-virtual {v1, v3}, Lio/bidmachine/media3/common/text/Cue$Builder;->setSize(F)Lio/bidmachine/media3/common/text/Cue$Builder;

    move-result-object v1

    iget v3, v7, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$RegionComposition;->height:I

    int-to-float v3, v3

    iget v5, v2, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$DisplayDefinition;->height:I
    ...
    .line 271
    invoke-virtual {v1, v3}, Lio/bidmachine/media3/common/text/Cue$Builder;->setBitmapHeight(F)Lio/bidmachine/media3/common/text/Cue$Builder;
    ...
    invoke-virtual {v1, v5, v3}, Landroid/graphics/Canvas;->drawColor(ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 279
    :cond_d
    new-instance v5, Lio/bidmachine/media3/extractor/text/CuesWithTiming;

    const-wide v7, -0x7fffffffffffffffL    # -4.9E-324

    const-wide v9, -0x7fffffffffffffffL    # -4.9E-324

    invoke-direct/range {v5 .. v10}, Lio/bidmachine/media3/extractor/text/CuesWithTiming;-><init>(Ljava/util/List;JJ)V
...
.method private static parseObjectData(Lio/bidmachine/media3/common/util/ParsableBitArray;)Lio/bidmachine/media3/extractor/text/dvb/DvbParser$ObjectData;
    ...
    .line 555
    sget-object v6, Lio/bidmachine/media3/common/util/Util;->EMPTY_BYTE_ARRAY:[B
    ...
    .line 570
    invoke-virtual {p0, v6, v4, v0}, Lio/bidmachine/media3/common/util/ParsableBitArray;->readBytes([BII)V
    ...
    invoke-direct {p0, v1, v3, v5, v6}, Lio/bidmachine/media3/extractor/text/dvb/DvbParser$ObjectData;-><init>(IZ[B[B)V
...
.method public parse([BIILio/bidmachine/media3/extractor/text/SubtitleParser$OutputOptions;Lio/bidmachine/media3/common/util/Consumer;)V
    ...
    .line 153
    new-instance p4, Lio/bidmachine/media3/common/util/ParsableBitArray;

    add-int/2addr p3, p2

    invoke-direct {p4, p1, p3}, Lio/bidmachine/media3/common/util/ParsableBitArray;-><init>([BI)V

    .line 154
    invoke-virtual {p4, p2}, Lio/bidmachine/media3/common/util/ParsableBitArray;->setPosition(I)V

    .line 155
    invoke-direct {p0, p4}, Lio/bidmachine/media3/extractor/text/dvb/DvbParser;->parse(Lio/bidmachine/media3/common/util/ParsableBitArray;)Lio/bidmachine/media3/extractor/text/CuesWithTiming;

    move-result-object p1

    invoke-interface {p5, p1}, Lio/bidmachine/media3/common/util/Consumer;->accept(Ljava/lang/Object;)V
