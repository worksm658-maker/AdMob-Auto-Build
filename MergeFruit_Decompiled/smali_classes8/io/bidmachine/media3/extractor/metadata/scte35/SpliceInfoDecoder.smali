...
.method protected decode(Lio/bidmachine/media3/extractor/metadata/MetadataInputBuffer;Ljava/nio/ByteBuffer;)Lio/bidmachine/media3/common/Metadata;
    ...
    .line 53
    iget-object v0, p0, Lio/bidmachine/media3/extractor/metadata/scte35/SpliceInfoDecoder;->timestampAdjuster:Lio/bidmachine/media3/common/util/TimestampAdjuster;

    if-eqz v0, :cond_0

    iget-wide v0, p1, Lio/bidmachine/media3/extractor/metadata/MetadataInputBuffer;->subsampleOffsetUs:J
    ...
    iget-wide v1, p1, Lio/bidmachine/media3/extractor/metadata/MetadataInputBuffer;->timeUs:J

    invoke-direct {v0, v1, v2}, Lio/bidmachine/media3/common/util/TimestampAdjuster;-><init>(J)V

    iput-object v0, p0, Lio/bidmachine/media3/extractor/metadata/scte35/SpliceInfoDecoder;->timestampAdjuster:Lio/bidmachine/media3/common/util/TimestampAdjuster;
    ...
    invoke-virtual {v0, v1, v2}, Lio/bidmachine/media3/common/util/TimestampAdjuster;->adjustSampleTimestamp(J)J
    ...
    .line 61
    iget-object v0, p0, Lio/bidmachine/media3/extractor/metadata/scte35/SpliceInfoDecoder;->sectionData:Lio/bidmachine/media3/common/util/ParsableByteArray;

    invoke-virtual {v0, p1, p2}, Lio/bidmachine/media3/common/util/ParsableByteArray;->reset([BI)V

    .line 62
    iget-object v0, p0, Lio/bidmachine/media3/extractor/metadata/scte35/SpliceInfoDecoder;->sectionHeader:Lio/bidmachine/media3/common/util/ParsableBitArray;

    invoke-virtual {v0, p1, p2}, Lio/bidmachine/media3/common/util/ParsableBitArray;->reset([BI)V
    ...
    invoke-virtual {p1, p2}, Lio/bidmachine/media3/common/util/ParsableBitArray;->readBits(I)I
    ...
    invoke-virtual {v2, p1}, Lio/bidmachine/media3/common/util/ParsableBitArray;->readBits(I)I
    ...
    invoke-virtual {p1, v2}, Lio/bidmachine/media3/common/util/ParsableBitArray;->readBits(I)I
    ...
    invoke-static {p1, v0, v1, v2}, Lio/bidmachine/media3/extractor/metadata/scte35/TimeSignalCommand;->parseFromSection(Lio/bidmachine/media3/common/util/ParsableByteArray;JLio/bidmachine/media3/common/util/TimestampAdjuster;)Lio/bidmachine/media3/extractor/metadata/scte35/TimeSignalCommand;
    ...
    .line 84
    invoke-static {p1, v0, v1, v2}, Lio/bidmachine/media3/extractor/metadata/scte35/SpliceInsertCommand;->parseFromSection(Lio/bidmachine/media3/common/util/ParsableByteArray;JLio/bidmachine/media3/common/util/TimestampAdjuster;)Lio/bidmachine/media3/extractor/metadata/scte35/SpliceInsertCommand;
    ...
    invoke-static {v2, p1, v0, v1}, Lio/bidmachine/media3/extractor/metadata/scte35/PrivateCommand;->parseFromSection(Lio/bidmachine/media3/common/util/ParsableByteArray;IJ)Lio/bidmachine/media3/extractor/metadata/scte35/PrivateCommand;
    ...
    new-array p2, p2, [Lio/bidmachine/media3/common/Metadata$Entry;
