.class public final Lio/bidmachine/media3/extractor/metadata/dvbsi/AppInfoTableDecoder;
...
.method private static parseAit(Lio/bidmachine/media3/common/util/ParsableBitArray;)Lio/bidmachine/media3/common/Metadata;
    .locals 14
    ...
    invoke-virtual {p0, v6, v10}, Lio/bidmachine/media3/common/util/ParsableBitArray;->readBytesAsString(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 118
    invoke-virtual {p0, v13}, Lio/bidmachine/media3/common/util/ParsableBitArray;->skipBytes(I)V
    ...
    invoke-virtual {p0, v11, v8}, Lio/bidmachine/media3/common/util/ParsableBitArray;->readBytesAsString(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 127
    invoke-virtual {p0, v12}, Lio/bidmachine/media3/common/util/ParsableBitArray;->setPosition(I)V
    ...
    .line 130
    invoke-virtual {p0, v9}, Lio/bidmachine/media3/common/util/ParsableBitArray;->setPosition(I)V
    ...
    .line 133
    new-instance v5, Lio/bidmachine/media3/extractor/metadata/dvbsi/AppInfoTable;
    ...
    invoke-direct {v5, v7, v6}, Lio/bidmachine/media3/extractor/metadata/dvbsi/AppInfoTable;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v4}, Lio/bidmachine/media3/common/Metadata;-><init>(Ljava/util/List;)V
...
.method protected decode(Lio/bidmachine/media3/extractor/metadata/MetadataInputBuffer;Ljava/nio/ByteBuffer;)Lio/bidmachine/media3/common/Metadata;
    ...
    invoke-direct {p1, v0, p2}, Lio/bidmachine/media3/common/util/ParsableBitArray;-><init>([BI)V

    invoke-static {p1}, Lio/bidmachine/media3/extractor/metadata/dvbsi/AppInfoTableDecoder;->parseAit(Lio/bidmachine/media3/common/util/ParsableBitArray;)Lio/bidmachine/media3/common/Metadata;
