...
.method public close()V
    ...
    .line 224
    invoke-virtual {p0}, Lio/bidmachine/media3/datasource/ContentDataSource;->transferEnded()V
...
.method public open(Lio/bidmachine/media3/datasource/DataSpec;)J
    ...
    .line 78
    :try_start_0
    iget-object v4, v0, Lio/bidmachine/media3/datasource/DataSpec;->uri:Landroid/net/Uri;
    ...
    .line 79
    iput-object v4, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->uri:Landroid/net/Uri;

    .line 81
    invoke-virtual/range {p0 .. p1}, Lio/bidmachine/media3/datasource/ContentDataSource;->transferInitializing(Lio/bidmachine/media3/datasource/DataSpec;)V
    ...
    .line 88
    iget-object v7, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->resolver:Landroid/content/ContentResolver;
    ...
    .line 93
    :cond_0
    iget-object v5, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->resolver:Landroid/content/ContentResolver;
    ...
    .line 95
    :goto_0
    iput-object v5, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->assetFileDescriptor:Landroid/content/res/AssetFileDescriptor;
    ...
    .line 105
    iput-object v2, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->inputStream:Ljava/io/FileInputStream;
    ...
    .line 134
    iput-wide v9, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->bytesRemaining:J
    ...
    iput-wide v3, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->bytesRemaining:J
    ...
    .line 144
    iput-wide v7, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->bytesRemaining:J
    :try_end_0
    .catch Lio/bidmachine/media3/datasource/ContentDataSource$ContentDataSourceException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    :cond_6
    iget-wide v4, v0, Lio/bidmachine/media3/datasource/DataSpec;->length:J
    ...
    .line 164
    :cond_7
    iput-boolean v6, v1, Lio/bidmachine/media3/datasource/ContentDataSource;->opened:Z

    .line 165
    invoke-virtual/range {p0 .. p1}, Lio/bidmachine/media3/datasource/ContentDataSource;->transferStarted(Lio/bidmachine/media3/datasource/DataSpec;)V
    ...
    :try_end_1
    .catch Lio/bidmachine/media3/datasource/ContentDataSource$ContentDataSourceException; {:try_start_1 .. :try_end_1} :catch_2
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1

    const/16 v15, 0x7d0

    :try_start_2
    invoke-direct {v0, v3, v15}, Lio/bidmachine/media3/datasource/ContentDataSource$ContentDataSourceException;-><init>(Ljava/io/IOException;I)V

    throw v0
    :try_end_2
    .catch Lio/bidmachine/media3/datasource/ContentDataSource$ContentDataSourceException; {:try_start_2 .. :try_end_2} :catch_2
    ...
    .line 153
    :goto_4
    new-instance v2, Lio/bidmachine/media3/datasource/ContentDataSource$ContentDataSourceException;
    ...
    .line 157
    :goto_5
    invoke-direct {v2, v0, v3}, Lio/bidmachine/media3/datasource/ContentDataSource$ContentDataSourceException;-><init>(Ljava/io/IOException;I)V
...
.method public read([BII)I
    ...
    .line 192
    :cond_4
    invoke-virtual {p0, p1}, Lio/bidmachine/media3/datasource/ContentDataSource;->bytesTransferred(I)V
