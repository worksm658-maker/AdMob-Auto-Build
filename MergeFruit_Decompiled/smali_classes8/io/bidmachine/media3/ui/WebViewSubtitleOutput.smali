...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 106
    invoke-virtual {p0, v1}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->addView(Landroid/view/View;)V

    .line 107
    invoke-virtual {p0, v2}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->addView(Landroid/view/View;)V
...
.method private static convertCaptionStyleToCssTextShadow(Lio/bidmachine/media3/ui/CaptionStyleCompat;)Ljava/lang/String;
    ...
    .line 369
    iget v0, p0, Lio/bidmachine/media3/ui/CaptionStyleCompat;->edgeType:I
...
.method private convertTextSizeToCss(IF)Ljava/lang/String;
    ...
    .line 360
    invoke-virtual {p0}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->getHeight()I
    ...
    invoke-virtual {p0}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->getPaddingTop()I

    move-result v2

    sub-int/2addr v1, v2

    invoke-virtual {p0}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->getPaddingBottom()I
    ...
    .line 364
    :cond_0
    invoke-virtual {p0}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->getContext()Landroid/content/Context;
    ...
    invoke-static {p2, p1}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method private static getBlockShearTransformFunction(Lio/bidmachine/media3/common/text/Cue;)Ljava/lang/String;
    ...
    .line 338
    iget v0, p0, Lio/bidmachine/media3/common/text/Cue;->shearDegrees:F
    ...
    .line 340
    iget v0, p0, Lio/bidmachine/media3/common/text/Cue;->verticalType:I
    ...
    .line 343
    :goto_1
    iget p0, p0, Lio/bidmachine/media3/common/text/Cue;->shearDegrees:F
...
.method private updateWebView()V
    ...
    invoke-static {v3, v2}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lio/bidmachine/media3/ui/HtmlUtils;->cssAllClassDescendantsSelector(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    iget-object v6, v0, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->style:Lio/bidmachine/media3/ui/CaptionStyleCompat;

    iget v6, v6, Lio/bidmachine/media3/ui/CaptionStyleCompat;->backgroundColor:I

    .line 189
    invoke-static {v6}, Lio/bidmachine/media3/ui/HtmlUtils;->toCssRgba(I)Ljava/lang/String;
    ...
    invoke-static {v7, v6}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 190
    :goto_0
    iget-object v7, v0, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->textCues:Ljava/util/List;
    ...
    check-cast v7, Lio/bidmachine/media3/common/text/Cue;

    .line 192
    iget v9, v7, Lio/bidmachine/media3/common/text/Cue;->position:F
    ...
    .line 193
    :goto_1
    iget v12, v7, Lio/bidmachine/media3/common/text/Cue;->positionAnchor:I

    invoke-static {v12}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->anchorTypeToTranslatePercent(I)I

    move-result v12

    .line 198
    iget v13, v7, Lio/bidmachine/media3/common/text/Cue;->line:F
    ...
    .line 199
    iget v13, v7, Lio/bidmachine/media3/common/text/Cue;->lineType:I
    ...
    invoke-static {v15, v13}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v13

    .line 214
    iget v14, v7, Lio/bidmachine/media3/common/text/Cue;->verticalType:I

    if-ne v14, v8, :cond_1

    .line 215
    iget v14, v7, Lio/bidmachine/media3/common/text/Cue;->lineAnchor:I
    ...
    invoke-static {v4, v13}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v15, v4}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 224
    iget v13, v7, Lio/bidmachine/media3/common/text/Cue;->size:F
    ...
    .line 225
    iget v10, v7, Lio/bidmachine/media3/common/text/Cue;->size:F
    ...
    invoke-static {v15, v10}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 228
    iget-object v10, v7, Lio/bidmachine/media3/common/text/Cue;->textAlignment:Landroid/text/Layout$Alignment;

    invoke-static {v10}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->convertAlignmentToCss(Landroid/text/Layout$Alignment;)Ljava/lang/String;

    move-result-object v24

    .line 229
    iget v10, v7, Lio/bidmachine/media3/common/text/Cue;->verticalType:I

    invoke-static {v10}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->convertVerticalTypeToCss(I)Ljava/lang/String;

    move-result-object v25

    .line 230
    iget v10, v7, Lio/bidmachine/media3/common/text/Cue;->textSizeType:I

    iget v11, v7, Lio/bidmachine/media3/common/text/Cue;->textSize:F

    invoke-direct {v0, v10, v11}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->convertTextSizeToCss(IF)Ljava/lang/String;

    move-result-object v26

    .line 232
    iget-boolean v10, v7, Lio/bidmachine/media3/common/text/Cue;->windowColorSet:Z

    if-eqz v10, :cond_6

    iget v10, v7, Lio/bidmachine/media3/common/text/Cue;->windowColor:I

    goto :goto_6

    :cond_6
    iget-object v10, v0, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->style:Lio/bidmachine/media3/ui/CaptionStyleCompat;

    iget v10, v10, Lio/bidmachine/media3/ui/CaptionStyleCompat;->windowColor:I

    :goto_6
    invoke-static {v10}, Lio/bidmachine/media3/ui/HtmlUtils;->toCssRgba(I)Ljava/lang/String;
    ...
    .line 254
    :goto_8
    iget v4, v7, Lio/bidmachine/media3/common/text/Cue;->verticalType:I
    ...
    .line 264
    iget-object v4, v7, Lio/bidmachine/media3/common/text/Cue;->text:Ljava/lang/CharSequence;

    .line 266
    invoke-virtual {v0}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->getContext()Landroid/content/Context;
    ...
    .line 265
    invoke-static {v4, v10}, Lio/bidmachine/media3/ui/SpannedToHtmlConverter;->convert(Ljava/lang/CharSequence;F)Lio/bidmachine/media3/ui/SpannedToHtmlConverter$HtmlAndCss;
    ...
    .line 271
    :goto_d
    invoke-static {v11}, Lio/bidmachine/media3/common/util/Assertions;->checkState(Z)V
    ...
    .line 304
    invoke-static {v7}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->getBlockShearTransformFunction(Lio/bidmachine/media3/common/text/Cue;)Ljava/lang/String;
    ...
    invoke-static {v9, v8}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 305
    invoke-static {v9, v10}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 307
    iget-object v8, v7, Lio/bidmachine/media3/common/text/Cue;->multiRowAlignment:Landroid/text/Layout$Alignment;

    if-eqz v8, :cond_11

    .line 308
    iget-object v7, v7, Lio/bidmachine/media3/common/text/Cue;->multiRowAlignment:Landroid/text/Layout$Alignment;

    .line 311
    invoke-static {v7}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->convertAlignmentToCss(Landroid/text/Layout$Alignment;)Ljava/lang/String;
    ...
    invoke-static {v8, v7}, Lio/bidmachine/media3/common/util/Util;->formatInvariant(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v4, v4, Lio/bidmachine/media3/ui/SpannedToHtmlConverter$HtmlAndCss;->html:Ljava/lang/String;
...
.method public update(Ljava/util/List;Lio/bidmachine/media3/ui/CaptionStyleCompat;FIF)V
    ...
    .line 142
    invoke-virtual {p0}, Lio/bidmachine/media3/ui/WebViewSubtitleOutput;->invalidate()V
