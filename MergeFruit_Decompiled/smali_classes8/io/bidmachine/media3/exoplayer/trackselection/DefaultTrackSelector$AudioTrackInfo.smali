...
# direct methods
.method public constructor <init>(ILio/bidmachine/media3/common/TrackGroup;ILio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;IZLcom/google/common/base/Predicate;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    .line 3876
    iget-boolean p1, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->allowAudioNonSeamlessAdaptiveness:Z
    ...
    .line 3880
    :goto_0
    iget-boolean p2, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->allowAudioMixedMimeTypeAdaptiveness:Z
    ...
    :goto_1
    iput-boolean p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->allowMixedMimeTypes:Z

    .line 3883
    iget-object p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->format:Lio/bidmachine/media3/common/Format;

    iget-object p2, p2, Lio/bidmachine/media3/common/Format;->language:Ljava/lang/String;

    invoke-static {p2}, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector;->normalizeUndeterminedLanguageToNull(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    iput-object p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->language:Ljava/lang/String;
    ...
    .line 3888
    :goto_2
    iget-object p8, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->preferredAudioLanguages:Lcom/google/common/collect/ImmutableList;
    ...
    .line 3889
    iget-object p8, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->format:Lio/bidmachine/media3/common/Format;

    iget-object v2, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->preferredAudioLanguages:Lcom/google/common/collect/ImmutableList;
    ...
    .line 3890
    invoke-static {p8, v2, v0}, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector;->getFormatLanguageScore(Lio/bidmachine/media3/common/Format;Ljava/lang/String;Z)I
    ...
    .line 3901
    iput p8, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->preferredLanguageScore:I
    ...
    iget p8, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->preferredAudioRoleFlags:I

    .line 3903
    invoke-static {p2, p8}, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector;->access$4200(II)I
    ...
    :goto_5
    iput-boolean p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->hasMainOrNoRoleFlag:Z
    ...
    :goto_6
    iput-boolean p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->isDefaultSelectionFlag:Z

    .line 3906
    iget-object p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->format:Lio/bidmachine/media3/common/Format;

    invoke-static {p2}, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector;->access$4500(Lio/bidmachine/media3/common/Format;)Z

    move-result p2

    iput-boolean p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->isObjectBasedAudio:Z
    ...
    iput p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->channelCount:I
    ...
    iput p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->sampleRate:I
    ...
    iput p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->bitrate:I
    ...
    iget v2, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->maxAudioBitrate:I
    ...
    iget p8, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->maxAudioChannelCount:I
    ...
    .line 3928
    :goto_9
    iput p7, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->localeLanguageMatchIndex:I

    .line 3929
    iput p8, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->localeLanguageScore:I

    move p2, v0

    .line 3931
    :goto_a
    iget-object p7, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->preferredAudioMimeTypes:Lcom/google/common/collect/ImmutableList;
    ...
    .line 3932
    iget-object p7, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->format:Lio/bidmachine/media3/common/Format;

    iget-object p7, p7, Lio/bidmachine/media3/common/Format;->sampleMimeType:Ljava/lang/String;
    ...
    iget-object p8, p4, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->preferredAudioMimeTypes:Lcom/google/common/collect/ImmutableList;
    ...
    :cond_d
    :goto_b
    iput v1, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->preferredMimeTypeMatchIndex:I
    ...
    :goto_d
    iput-boolean p3, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->usesHardwareAcceleration:Z

    .line 3946
    invoke-direct {p0, p5, p6, p1}, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->evaluateSelectionEligibility(IZI)I
...
.method public static createForTrackGroup(ILio/bidmachine/media3/common/TrackGroup;Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;[IZLcom/google/common/base/Predicate;I)Lcom/google/common/collect/ImmutableList;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    invoke-direct/range {v2 .. v10}, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;-><init>(ILio/bidmachine/media3/common/TrackGroup;ILio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;IZLcom/google/common/base/Predicate;I)V
...
.method private evaluateSelectionEligibility(IZI)I
    ...
    iget-object v0, v0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->audioOffloadPreferences:Lio/bidmachine/media3/common/TrackSelectionParameters$AudioOffloadPreferences;
    ...
    iget-object v3, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->format:Lio/bidmachine/media3/common/Format;

    .line 4035
    invoke-static {v0, p1, v3}, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector;->access$4600(Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;ILio/bidmachine/media3/common/Format;)Z
    ...
    iget-object v0, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->format:Lio/bidmachine/media3/common/Format;
    ...
    iget-boolean v0, v0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->allowMultipleAdaptiveSelections:Z
    ...
    :cond_3
    iget-object p2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->parameters:Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;

    iget-object p2, p2, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->audioOffloadPreferences:Lio/bidmachine/media3/common/TrackSelectionParameters$AudioOffloadPreferences;

    iget p2, p2, Lio/bidmachine/media3/common/TrackSelectionParameters$AudioOffloadPreferences;->audioOffloadMode:I
...
.method public compareTo(Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;)I
    ...
    .line 4004
    iget-object v2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->parameters:Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;
    ...
    iget-boolean v2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->isObjectBasedAudio:Z

    iget-boolean v3, p1, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->isObjectBasedAudio:Z
    ...
    .line 4017
    iget-object v2, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->language:Ljava/lang/String;

    iget-object v3, p1, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->language:Ljava/lang/String;
    ...
    iget p1, p1, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->bitrate:I
...
.method public isCompatibleForAdaptationWith(Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;)Z
    ...
    iget-boolean v0, v0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->allowAudioMixedChannelCountAdaptiveness:Z
    ...
    iget-object v2, p1, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->format:Lio/bidmachine/media3/common/Format;
    ...
    :cond_0
    iget-boolean v0, p0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->allowMixedMimeTypes:Z
    ...
    iget-boolean v0, v0, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$Parameters;->allowAudioMixedSampleRateAdaptiveness:Z
    ...
    iget-object v1, p1, Lio/bidmachine/media3/exoplayer/trackselection/DefaultTrackSelector$AudioTrackInfo;->format:Lio/bidmachine/media3/common/Format;
