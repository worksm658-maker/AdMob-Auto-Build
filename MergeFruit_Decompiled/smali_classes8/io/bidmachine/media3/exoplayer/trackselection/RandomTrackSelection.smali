...
.method public constructor <init>(Lio/bidmachine/media3/common/TrackGroup;[IILjava/util/Random;)V
    ...
    .line 82
    iget p1, p0, Lio/bidmachine/media3/exoplayer/trackselection/RandomTrackSelection;->length:I
...
.method public updateSelectedTrack(JJJLjava/util/List;[Lio/bidmachine/media3/exoplayer/source/chunk/MediaChunkIterator;)V
    ...
    .line 95
    :goto_0
    iget p6, p0, Lio/bidmachine/media3/exoplayer/trackselection/RandomTrackSelection;->length:I

    if-ge p4, p6, :cond_1

    .line 96
    invoke-virtual {p0, p4, p1, p2}, Lio/bidmachine/media3/exoplayer/trackselection/RandomTrackSelection;->isTrackExcluded(IJ)Z
    ...
    .line 102
    iget p4, p0, Lio/bidmachine/media3/exoplayer/trackselection/RandomTrackSelection;->length:I
    ...
    .line 105
    :goto_1
    iget p5, p0, Lio/bidmachine/media3/exoplayer/trackselection/RandomTrackSelection;->length:I

    if-ge p3, p5, :cond_4

    .line 106
    invoke-virtual {p0, p3, p1, p2}, Lio/bidmachine/media3/exoplayer/trackselection/RandomTrackSelection;->isTrackExcluded(IJ)Z
