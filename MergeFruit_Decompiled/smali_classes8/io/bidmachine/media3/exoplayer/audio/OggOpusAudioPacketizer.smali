...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->OGG_DEFAULT_ID_HEADER_PAGE:[B
    ...
    sput-object v0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->OGG_DEFAULT_COMMENT_HEADER_PAGE:[B
...
.method private packetizeInternal(Ljava/nio/ByteBuffer;[B)Ljava/nio/ByteBuffer;
    ...
    .line 128
    iget v3, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->pageSequenceNumber:I
    ...
    .line 132
    :cond_0
    sget-object v3, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->OGG_DEFAULT_ID_HEADER_PAGE:[B

    array-length v3, v3

    .line 133
    :goto_0
    sget-object v4, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->OGG_DEFAULT_COMMENT_HEADER_PAGE:[B
    ...
    .line 137
    :goto_1
    invoke-direct {p0, v2}, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->replaceOutputBuffer(I)Ljava/nio/ByteBuffer;
    ...
    .line 142
    invoke-direct {p0, v2, v1}, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->writeOggIdHeaderPage(Ljava/nio/ByteBuffer;[B)V

    goto :goto_2

    .line 145
    :cond_2
    sget-object v1, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->OGG_DEFAULT_ID_HEADER_PAGE:[B

    invoke-virtual {v2, v1}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    .line 147
    :goto_2
    sget-object v1, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->OGG_DEFAULT_COMMENT_HEADER_PAGE:[B

    invoke-virtual {v2, v1}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    .line 151
    :cond_3
    invoke-static {v7}, Lio/bidmachine/media3/extractor/OpusUtil;->parsePacketAudioSampleCount(Ljava/nio/ByteBuffer;)I

    move-result v1

    .line 152
    iget v3, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->granulePosition:I

    add-int/2addr v3, v1

    iput v3, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->granulePosition:I
    ...
    .line 154
    iget v4, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->pageSequenceNumber:I

    const/4 v6, 0x0

    move-object v0, p0

    invoke-direct/range {v0 .. v6}, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->writeOggPacketHeader(Ljava/nio/ByteBuffer;JIIZ)V
    ...
    .line 178
    iget v2, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->pageSequenceNumber:I
    ...
    sget-object v5, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->OGG_DEFAULT_COMMENT_HEADER_PAGE:[B
    ...
    .line 180
    invoke-static {v2, v4, v6, v12}, Lio/bidmachine/media3/common/util/Util;->crc32([BIII)I
    ...
    .line 191
    invoke-static {v2, v4, v5, v12}, Lio/bidmachine/media3/common/util/Util;->crc32([BIII)I
    ...
    iput v2, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->pageSequenceNumber:I
...
.method private writeOggIdHeaderPage(Ljava/nio/ByteBuffer;[B)V
    ...
    .line 222
    invoke-static {p1, v0, v2, v3}, Lio/bidmachine/media3/common/util/Util;->crc32([BIII)I
...
# virtual methods
.method public packetize(Lio/bidmachine/media3/decoder/DecoderInputBuffer;Ljava/util/List;)V
    .locals 2
    ...
    .line 83
    :cond_0
    iget v0, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->pageSequenceNumber:I
    ...
    invoke-direct {p0, v0, p2}, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->packetizeInternal(Ljava/nio/ByteBuffer;[B)Ljava/nio/ByteBuffer;

    move-result-object p2

    iput-object p2, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->outputBuffer:Ljava/nio/ByteBuffer;

    .line 87
    invoke-virtual {p1}, Lio/bidmachine/media3/decoder/DecoderInputBuffer;->clear()V

    .line 88
    iget-object p2, p0, Lio/bidmachine/media3/exoplayer/audio/OggOpusAudioPacketizer;->outputBuffer:Ljava/nio/ByteBuffer;
    ...
    .line 89
    iget-object p2, p1, Lio/bidmachine/media3/decoder/DecoderInputBuffer;->data:Ljava/nio/ByteBuffer;
