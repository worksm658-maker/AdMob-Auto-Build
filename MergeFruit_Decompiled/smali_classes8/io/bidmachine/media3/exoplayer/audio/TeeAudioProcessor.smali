...
.method private flushSinkIfActive()V
    ...
    .line 105
    invoke-virtual {p0}, Lio/bidmachine/media3/exoplayer/audio/TeeAudioProcessor;->isActive()Z
    ...
    iget-object v1, p0, Lio/bidmachine/media3/exoplayer/audio/TeeAudioProcessor;->inputAudioFormat:Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;

    iget v1, v1, Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;->sampleRate:I

    iget-object v2, p0, Lio/bidmachine/media3/exoplayer/audio/TeeAudioProcessor;->inputAudioFormat:Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;

    iget v2, v2, Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;->channelCount:I

    iget-object v3, p0, Lio/bidmachine/media3/exoplayer/audio/TeeAudioProcessor;->inputAudioFormat:Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;

    iget v3, v3, Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;->encoding:I

    invoke-interface {v0, v1, v2, v3}, Lio/bidmachine/media3/exoplayer/audio/TeeAudioProcessor$AudioBufferSink;->flush(III)V
...
.method public queueInput(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1}, Lio/bidmachine/media3/common/util/Util;->createReadOnlyByteBuffer(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 86
    invoke-virtual {p0, v0}, Lio/bidmachine/media3/exoplayer/audio/TeeAudioProcessor;->replaceOutputBuffer(I)Ljava/nio/ByteBuffer;
