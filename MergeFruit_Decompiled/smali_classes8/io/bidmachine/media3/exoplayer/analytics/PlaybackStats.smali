...
.method public static varargs merge([Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;)Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;
    ...
    .line 296
    iget v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->playbackCount:I
    ...
    iget-object v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->playbackStateDurationsMs:[J
    ...
    .line 301
    iget-wide v12, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->firstReportedTimeMs:J

    goto :goto_2

    .line 302
    :cond_1
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->firstReportedTimeMs:J
    ...
    :cond_2
    :goto_2
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->foregroundPlaybackCount:I

    add-int/2addr v8, v0

    .line 306
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->abandonedBeforeReadyCount:I

    add-int/2addr v10, v0

    .line 307
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->endedCount:I

    add-int/2addr v11, v0

    .line 308
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->backgroundJoiningCount:I
    ...
    .line 310
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalValidJoinTimeMs:J
    ...
    :cond_4
    :goto_3
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->validJoinTimeCount:I

    add-int v17, v17, v0

    .line 315
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalPauseCount:I

    add-int v18, v18, v0

    .line 316
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalPauseBufferCount:I

    add-int v19, v19, v0

    .line 317
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalSeekCount:I

    add-int v20, v20, v0

    .line 318
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalRebufferCount:I
    ...
    .line 320
    iget-wide v5, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->maxRebufferTimeMs:J

    goto :goto_4

    .line 321
    :cond_5
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->maxRebufferTimeMs:J
    ...
    :cond_6
    :goto_4
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->adPlaybackCount:I

    add-int v24, v24, v0

    .line 325
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalVideoFormatHeightTimeMs:J

    add-long v25, v25, v0

    .line 326
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalVideoFormatHeightTimeProduct:J

    add-long v27, v27, v0

    .line 327
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalVideoFormatBitrateTimeMs:J

    add-long v29, v29, v0

    .line 328
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalVideoFormatBitrateTimeProduct:J

    add-long v31, v31, v0

    .line 329
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalAudioFormatTimeMs:J

    add-long v33, v33, v0

    .line 330
    iget-wide v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalAudioFormatBitrateTimeProduct:J

    add-long v35, v35, v0

    .line 331
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->initialVideoFormatHeightCount:I

    add-int v37, v37, v0

    .line 332
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->initialVideoFormatBitrateCount:I
    ...
    .line 334
    iget v0, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalInitialVideoFormatHeight:I
    ...
    .line 339
    iget-wide v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalInitialVideoFormatBitrate:J
    ...
    :cond_a
    :goto_6
    iget v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->initialAudioFormatBitrateCount:I
    ...
    .line 345
    iget-wide v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalInitialAudioFormatBitrate:J
    ...
    :cond_c
    :goto_7
    iget-wide v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalBandwidthTimeMs:J

    add-long v45, v45, v1

    .line 350
    iget-wide v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalBandwidthBytes:J

    add-long v47, v47, v1

    .line 351
    iget-wide v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalDroppedFrames:J

    add-long v49, v49, v1

    .line 352
    iget-wide v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->totalAudioUnderruns:J

    add-long v51, v51, v1

    .line 353
    iget v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->fatalErrorPlaybackCount:I

    add-int v53, v53, v1

    .line 354
    iget v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->fatalErrorCount:I

    add-int v54, v54, v1

    .line 355
    iget v1, v9, Lio/bidmachine/media3/exoplayer/analytics/PlaybackStats;->nonFatalErrorCount:I
