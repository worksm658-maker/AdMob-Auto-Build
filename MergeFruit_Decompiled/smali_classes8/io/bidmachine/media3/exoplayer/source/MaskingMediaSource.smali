...
.method private setPreparePositionOverrideToUnpreparedMaskingPeriod(J)Z
    ...
    invoke-virtual {v2, v1, v3}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource$MaskingTimeline;->getPeriod(ILio/bidmachine/media3/common/Timeline$Period;)Lio/bidmachine/media3/common/Timeline$Period;
...
.method public canUpdateMediaItem(Lio/bidmachine/media3/common/MediaItem;)Z
    ...
    .line 82
    iget-object v0, p0, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->mediaSource:Lio/bidmachine/media3/exoplayer/source/MediaSource;
...
.method public createPeriod(Lio/bidmachine/media3/exoplayer/source/MediaSource$MediaPeriodId;Lio/bidmachine/media3/exoplayer/upstream/Allocator;J)Lio/bidmachine/media3/exoplayer/source/MaskingMediaPeriod;
    ...
    .line 116
    iget-object p2, p0, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->mediaSource:Lio/bidmachine/media3/exoplayer/source/MediaSource;
    ...
    .line 118
    iget-object p2, p1, Lio/bidmachine/media3/exoplayer/source/MediaSource$MediaPeriodId;->periodUid:Ljava/lang/Object;
    ...
    .line 127
    invoke-virtual {p0}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->prepareChildSource()V
...
.method protected onChildSourceInfoRefreshed(Lio/bidmachine/media3/common/Timeline;)V
    ...
    .line 155
    invoke-direct {p0, v0, v1}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->setPreparePositionOverrideToUnpreparedMaskingPeriod(J)Z
    ...
    iget-object v7, v7, Lio/bidmachine/media3/exoplayer/source/MediaSource$MediaPeriodId;->periodUid:Ljava/lang/Object;
    ...
    invoke-virtual {v6, v7, v8}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource$MaskingTimeline;->getPeriodByUid(Ljava/lang/Object;Lio/bidmachine/media3/common/Timeline$Period;)Lio/bidmachine/media3/common/Timeline$Period;
    ...
    .line 187
    invoke-virtual {v4, v1, v5}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource$MaskingTimeline;->getWindow(ILio/bidmachine/media3/common/Timeline$Window;)Lio/bidmachine/media3/common/Timeline$Window;
    ...
    .line 203
    invoke-direct {p0, v2, v3}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->setPreparePositionOverrideToUnpreparedMaskingPeriod(J)Z
    ...
    .line 205
    invoke-direct {p0, p1}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->getInternalPeriodUid(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    invoke-virtual {v0, p1}, Lio/bidmachine/media3/exoplayer/source/MediaSource$MediaPeriodId;->copyWithPeriodUid(Ljava/lang/Object;)Lio/bidmachine/media3/exoplayer/source/MediaSource$MediaPeriodId;
    ...
    invoke-virtual {p0, v0}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->refreshSourceInfo(Lio/bidmachine/media3/common/Timeline;)V
...
.method public updateMediaItem(Lio/bidmachine/media3/common/MediaItem;)V
    ...
    new-instance v1, Lio/bidmachine/media3/exoplayer/source/TimelineWithUpdatedMediaItem;

    iget-object v2, p0, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->timeline:Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource$MaskingTimeline;

    iget-object v2, v2, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource$MaskingTimeline;->timeline:Lio/bidmachine/media3/common/Timeline;

    invoke-direct {v1, v2, p1}, Lio/bidmachine/media3/exoplayer/source/TimelineWithUpdatedMediaItem;-><init>(Lio/bidmachine/media3/common/Timeline;Lio/bidmachine/media3/common/MediaItem;)V

    .line 89
    invoke-virtual {v0, v1}, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource$MaskingTimeline;->cloneWithUpdatedTimeline(Lio/bidmachine/media3/common/Timeline;)Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource$MaskingTimeline;

    move-result-object v0

    iput-object v0, p0, Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource;->timeline:Lio/bidmachine/media3/exoplayer/source/MaskingMediaSource$MaskingTimeline;
