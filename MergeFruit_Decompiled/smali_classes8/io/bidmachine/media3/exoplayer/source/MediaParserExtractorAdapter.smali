...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter$Factory;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    .line 54
    new-instance v0, Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter$$ExternalSyntheticLambda0;

    invoke-direct {v0}, Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter$$ExternalSyntheticLambda0;-><init>()V
...
.method public constructor <init>(Lio/bidmachine/media3/exoplayer/analytics/PlayerId;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter;-><init>(Lio/bidmachine/media3/exoplayer/analytics/PlayerId;Ljava/util/Map;)V

    return-void
.end method

.method private constructor <init>(Lio/bidmachine/media3/exoplayer/analytics/PlayerId;Ljava/util/Map;)V
    .locals 3
    ...
    .line 107
    iget-object v1, p0, Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter;->mediaParser:Landroid/media/MediaParser;
    ...
    iput-object p2, p0, Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter;->parserName:Ljava/lang/String;
    ...
    .line 111
    iget-object p2, p0, Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter;->mediaParser:Landroid/media/MediaParser;

    invoke-static {p2, p1}, Lio/bidmachine/media3/exoplayer/source/mediaparser/MediaParserUtil;->setLogSessionIdOnMediaParser(Landroid/media/MediaParser;Lio/bidmachine/media3/exoplayer/analytics/PlayerId;)V

    :cond_1
    return-void
.end method

.method synthetic constructor <init>(Lio/bidmachine/media3/exoplayer/analytics/PlayerId;Ljava/util/Map;Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter$1;)V
    .locals 0

    .line 48
    invoke-direct {p0, p1, p2}, Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter;-><init>(Lio/bidmachine/media3/exoplayer/analytics/PlayerId;Ljava/util/Map;)V

    return-void
.end method

.method static synthetic lambda$static$0(Lio/bidmachine/media3/exoplayer/analytics/PlayerId;)Lio/bidmachine/media3/exoplayer/source/ProgressiveMediaExtractor;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Lio/bidmachine/media3/exoplayer/source/MediaParserExtractorAdapter;-><init>(Lio/bidmachine/media3/exoplayer/analytics/PlayerId;Ljava/util/Map;)V
...
.method public read(Lio/bidmachine/media3/extractor/PositionHolder;)I
    ...
    .line 172
    :cond_0
    iget-wide v0, p1, Lio/bidmachine/media3/extractor/PositionHolder;->position:J
