...
.method private acquireFirstSessionOnHandlerThread(I[BLio/bidmachine/media3/common/Format;)Lio/bidmachine/media3/exoplayer/drm/DrmSession;
    ...
    new-instance v1, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda1;
    ...
    invoke-direct/range {v1 .. v6}, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda1;-><init>(Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper;I[BLcom/google/common/util/concurrent/SettableFuture;Lio/bidmachine/media3/common/Format;)V
    ...
    new-instance v0, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0, p1, p2}, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda2;-><init>(Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper;Lio/bidmachine/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/SettableFuture;)V
...
.method private acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(I[BLio/bidmachine/media3/common/Format;)[B
    ...
    new-instance v0, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda3;

    invoke-direct {v0, p0, p2, p1}, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda3;-><init>(Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/SettableFuture;Lio/bidmachine/media3/exoplayer/drm/DrmSession;)V
...
.method private releaseManagerOnHandlerThread()V
    ...
    new-instance v2, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda4;

    invoke-direct {v2, p0, v0}, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda4;-><init>(Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/SettableFuture;)V
...
.method public declared-synchronized getLicenseDurationRemainingSec([B)Landroid/util/Pair;
    ...
    new-instance v2, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda0;

    invoke-direct {v2, p0, v0, p1}, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper$$ExternalSyntheticLambda0;-><init>(Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/SettableFuture;Lio/bidmachine/media3/exoplayer/drm/DrmSession;)V
    ...
    .line 233
    invoke-virtual {p1}, Lio/bidmachine/media3/exoplayer/drm/DrmSession$DrmSessionException;->getCause()Ljava/lang/Throwable;
...
.method synthetic lambda$acquireFirstSessionOnHandlerThread$2$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper(I[BLcom/google/common/util/concurrent/SettableFuture;Lio/bidmachine/media3/common/Format;)V
    .locals 3
    ...
    .line 337
    :try_start_2
    iget-object p2, p0, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper;->drmSessionManager:Lio/bidmachine/media3/exoplayer/drm/DefaultDrmSessionManager;

    invoke-virtual {p2}, Lio/bidmachine/media3/exoplayer/drm/DefaultDrmSessionManager;->release()V
...
.method synthetic lambda$acquireFirstSessionOnHandlerThread$3$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper(Lio/bidmachine/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/SettableFuture;)V
    .locals 3
    ...
    invoke-virtual {p1}, Lio/bidmachine/media3/exoplayer/drm/DefaultDrmSessionManager;->release()V

    return-void
.end method

.method synthetic lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper(Lcom/google/common/util/concurrent/SettableFuture;Lio/bidmachine/media3/exoplayer/drm/DrmSession;)V
    .locals 1
    ...
    .line 286
    iget-object p1, p0, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper;->eventDispatcher:Lio/bidmachine/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;

    invoke-interface {p2, p1}, Lio/bidmachine/media3/exoplayer/drm/DrmSession;->release(Lio/bidmachine/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;)V
    ...
    iget-object v0, p0, Lio/bidmachine/media3/exoplayer/drm/OfflineLicenseHelper;->eventDispatcher:Lio/bidmachine/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;

    invoke-interface {p2, v0}, Lio/bidmachine/media3/exoplayer/drm/DrmSession;->release(Lio/bidmachine/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;)V

    .line 287
    throw p1
.end method

.method synthetic lambda$getLicenseDurationRemainingSec$0$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper(Lcom/google/common/util/concurrent/SettableFuture;Lio/bidmachine/media3/exoplayer/drm/DrmSession;)V
    .locals 1
...
.method synthetic lambda$releaseManagerOnHandlerThread$4$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper(Lcom/google/common/util/concurrent/SettableFuture;)V
    .locals 1
    ...
    invoke-virtual {v0}, Lio/bidmachine/media3/exoplayer/drm/DefaultDrmSessionManager;->release()V
