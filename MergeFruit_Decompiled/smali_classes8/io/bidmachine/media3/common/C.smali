...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/bidmachine/media3/common/C$TextureMinFilter;,
        Lio/bidmachine/media3/common/C$FirstFrameState;,
        Lio/bidmachine/media3/common/C$FormatSupport;,
        Lio/bidmachine/media3/common/C$AuxiliaryTrackType;,
        Lio/bidmachine/media3/common/C$RoleFlags;,
        Lio/bidmachine/media3/common/C$WakeMode;,
        Lio/bidmachine/media3/common/C$NetworkType;,
        Lio/bidmachine/media3/common/C$Priority;,
        Lio/bidmachine/media3/common/C$Projection;,
        Lio/bidmachine/media3/common/C$ColorRange;,
        Lio/bidmachine/media3/common/C$ColorTransfer;,
        Lio/bidmachine/media3/common/C$ColorSpace;,
        Lio/bidmachine/media3/common/C$StereoMode;,
        Lio/bidmachine/media3/common/C$SelectionReason;,
        Lio/bidmachine/media3/common/C$TrackType;,
        Lio/bidmachine/media3/common/C$DataType;,
        Lio/bidmachine/media3/common/C$ContentType;,
        Lio/bidmachine/media3/common/C$SelectionFlags;,
        Lio/bidmachine/media3/common/C$VideoChangeFrameRateStrategy;,
        Lio/bidmachine/media3/common/C$VideoScalingMode;,
        Lio/bidmachine/media3/common/C$VideoOutputMode;,
        Lio/bidmachine/media3/common/C$BufferFlags;,
        Lio/bidmachine/media3/common/C$VideoCodecFlags;,
        Lio/bidmachine/media3/common/C$AudioAllowedCapturePolicy;,
        Lio/bidmachine/media3/common/C$AudioUsage;,
        Lio/bidmachine/media3/common/C$AudioFlags;,
        Lio/bidmachine/media3/common/C$AudioContentType;,
        Lio/bidmachine/media3/common/C$VolumeFlags;,
        Lio/bidmachine/media3/common/C$StreamType;,
        Lio/bidmachine/media3/common/C$SpatializationBehavior;,
        Lio/bidmachine/media3/common/C$PcmEncoding;,
        Lio/bidmachine/media3/common/C$Encoding;,
        Lio/bidmachine/media3/common/C$CryptoMode;,
        Lio/bidmachine/media3/common/C$CryptoType;
    }
.end annotation
...
.field public static final AUXILIARY_TRACK_TYPE_DEPTH_INVERSE:I = 0x3

.field public static final AUXILIARY_TRACK_TYPE_DEPTH_LINEAR:I = 0x2

.field public static final AUXILIARY_TRACK_TYPE_DEPTH_METADATA:I = 0x4

.field public static final AUXILIARY_TRACK_TYPE_ORIGINAL:I = 0x1

.field public static final AUXILIARY_TRACK_TYPE_UNDEFINED:I = 0x0
...
.field public static final BUFFER_FLAG_NOT_DEPENDED_ON:I = 0x4000000
...
.field public static final ROLE_FLAG_AUXILIARY:I = 0x8000
...
.field public static final STEREO_MODE_INTERLEAVED_LEFT_PRIMARY:I = 0x4

.field public static final STEREO_MODE_INTERLEAVED_RIGHT_PRIMARY:I = 0x5
...
.field public static final STREAM_TYPE_ACCESSIBILITY:I = 0xa
...
.field public static final TEXTURE_MIN_FILTER_LINEAR:I = 0x2601

.field public static final TEXTURE_MIN_FILTER_LINEAR_MIPMAP_LINEAR:I = 0x2703
...
.field public static final VIDEO_CODEC_FLAG_H264:I = 0x1

.field public static final VIDEO_CODEC_FLAG_H265:I = 0x2
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/bidmachine/media3/common/C;->UUID_NIL:Ljava/util/UUID;
    ...
    sput-object v0, Lio/bidmachine/media3/common/C;->COMMON_PSSH_UUID:Ljava/util/UUID;
    ...
    sput-object v0, Lio/bidmachine/media3/common/C;->CLEARKEY_UUID:Ljava/util/UUID;
    ...
    sput-object v0, Lio/bidmachine/media3/common/C;->WIDEVINE_UUID:Ljava/util/UUID;
    ...
    sput-object v0, Lio/bidmachine/media3/common/C;->PLAYREADY_UUID:Ljava/util/UUID;
...
.method public static generateAudioSessionIdV21(Landroid/content/Context;)I
    ...
    .line 1794
    invoke-static {p0}, Lio/bidmachine/media3/common/util/Util;->generateAudioSessionIdV21(Landroid/content/Context;)I
...
.method public static getFormatSupportString(I)Ljava/lang/String;
    ...
    .line 1806
    invoke-static {p0}, Lio/bidmachine/media3/common/util/Util;->getFormatSupportString(I)Ljava/lang/String;
