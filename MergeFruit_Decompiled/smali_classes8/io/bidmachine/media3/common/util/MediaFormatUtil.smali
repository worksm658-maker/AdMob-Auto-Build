.class public final Lio/bidmachine/media3/common/util/MediaFormatUtil;
...
.method public static createFormatFromMediaFormat(Landroid/media/MediaFormat;)Lio/bidmachine/media3/common/Format;
    .locals 5
    ...
    invoke-static {p0, v1, v2}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    .line 83
    invoke-static {p0}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getCodecString(Landroid/media/MediaFormat;)Ljava/lang/String;
    ...
    .line 84
    invoke-static {p0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getFrameRate(Landroid/media/MediaFormat;F)F
    ...
    .line 91
    invoke-static {p0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getPixelWidthHeightRatio(Landroid/media/MediaFormat;F)F
    ...
    invoke-static {p0, v1, v3}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    .line 99
    invoke-static {p0}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getColorInfo(Landroid/media/MediaFormat;)Lio/bidmachine/media3/common/ColorInfo;
    ...
    invoke-virtual {v0, p0}, Lio/bidmachine/media3/common/Format$Builder;->setId(I)Lio/bidmachine/media3/common/Format$Builder;
...
.method public static createMediaFormatFromFormat(Lio/bidmachine/media3/common/Format;)Landroid/media/MediaFormat;
    .locals 4
    ...
    invoke-static {v0, v1, v2}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetColorInfo(Landroid/media/MediaFormat;Lio/bidmachine/media3/common/ColorInfo;)V
    ...
    invoke-static {v0, v1, v2}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetString(Landroid/media/MediaFormat;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v2}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetFloat(Landroid/media/MediaFormat;Ljava/lang/String;F)V
    ...
    invoke-static {v0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->setCsdBuffers(Landroid/media/MediaFormat;Ljava/util/List;)V

    .line 164
    iget v1, p0, Lio/bidmachine/media3/common/Format;->pcmEncoding:I

    invoke-static {v0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetPcmEncoding(Landroid/media/MediaFormat;I)V
    ...
    invoke-static {v0, v3, v2}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->setBooleanAsInt(Landroid/media/MediaFormat;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v2, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->setBooleanAsInt(Landroid/media/MediaFormat;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetPixelAspectRatio(Landroid/media/MediaFormat;F)V
    ...
    .line 184
    iget-object p0, p0, Lio/bidmachine/media3/common/Format;->id:Ljava/lang/String;
...
.method private static getCodecString(Landroid/media/MediaFormat;)Ljava/lang/String;
    ...
    .line 350
    invoke-static {v0, p0}, Lio/bidmachine/media3/common/util/CodecSpecificDataUtil;->buildH263CodecString(II)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getString(Landroid/media/MediaFormat;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static getColorInfo(Landroid/media/MediaFormat;)Lio/bidmachine/media3/common/ColorInfo;
    .locals 6
    ...
    .line 285
    invoke-static {p0, v0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    .line 288
    invoke-static {p0, v3, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    .line 290
    invoke-static {p0, v4, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    .line 296
    invoke-static {p0}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getArray(Ljava/nio/ByteBuffer;)[B
    ...
    .line 299
    :goto_0
    invoke-static {v0}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->isValidColorSpace(I)Z
    ...
    .line 302
    :cond_2
    invoke-static {v3}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->isValidColorRange(I)Z
    ...
    .line 305
    :cond_3
    invoke-static {v4}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->isValidColorTransfer(I)Z
    ...
    .line 313
    invoke-virtual {v1, v0}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorSpace(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object v0

    .line 314
    invoke-virtual {v0, v3}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorRange(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object v0

    .line 315
    invoke-virtual {v0, v4}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorTransfer(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object v0

    .line 316
    invoke-virtual {v0, p0}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setHdrStaticInfo([B)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object p0

    .line 317
    invoke-virtual {p0}, Lio/bidmachine/media3/common/ColorInfo$Builder;->build()Lio/bidmachine/media3/common/ColorInfo;
...
.method public static maybeSetColorInfo(Landroid/media/MediaFormat;Lio/bidmachine/media3/common/ColorInfo;)V
    .locals 2
    ...
    iget v1, p1, Lio/bidmachine/media3/common/ColorInfo;->colorTransfer:I

    invoke-static {p0, v0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)V

    .line 265
    const-string v0, "color-standard"

    iget v1, p1, Lio/bidmachine/media3/common/ColorInfo;->colorSpace:I
    ...
    iget v1, p1, Lio/bidmachine/media3/common/ColorInfo;->colorRange:I
    ...
    invoke-static {p0, v0, p1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetByteBuffer(Landroid/media/MediaFormat;Ljava/lang/String;[B)V
...
.method private static maybeSetPcmEncoding(Landroid/media/MediaFormat;I)V
    ...
    invoke-static {p0, v0, p1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)V
