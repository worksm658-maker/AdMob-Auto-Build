...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/bidmachine/media3/common/util/Util$Api29;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/bidmachine/media3/common/util/Util;->MANUFACTURER:Ljava/lang/String;

    .line 176
    sget-object v1, Landroid/os/Build;->MODEL:Ljava/lang/String;

    sput-object v1, Lio/bidmachine/media3/common/util/Util;->MODEL:Ljava/lang/String;
    ...
    sput-object v1, Lio/bidmachine/media3/common/util/Util;->EMPTY_BYTE_ARRAY:[B

    .line 187
    new-array v1, v0, [J

    sput-object v1, Lio/bidmachine/media3/common/util/Util;->EMPTY_LONG_ARRAY:[J
    ...
    sput-object v1, Lio/bidmachine/media3/common/util/Util;->XS_DATE_TIME_PATTERN:Ljava/util/regex/Pattern;
    ...
    sput-object v1, Lio/bidmachine/media3/common/util/Util;->XS_DURATION_PATTERN:Ljava/util/regex/Pattern;
    ...
    sput-object v1, Lio/bidmachine/media3/common/util/Util;->ESCAPED_CHARACTER_PATTERN:Ljava/util/regex/Pattern;
    ...
    sput-object v1, Lio/bidmachine/media3/common/util/Util;->ISM_PATH_PATTERN:Ljava/util/regex/Pattern;
    ...
    sput-object v1, Lio/bidmachine/media3/common/util/Util;->additionalIsoLanguageReplacements:[Ljava/lang/String;
    ...
    sput-object v1, Lio/bidmachine/media3/common/util/Util;->isoLegacyTagReplacements:[Ljava/lang/String;
    ...
    sput-object v0, Lio/bidmachine/media3/common/util/Util;->CRC16_BYTES_MSBF:[I
...
.method public static crc16([BIII)I
    ...
    .line 2921
    invoke-static {v1, p3}, Lio/bidmachine/media3/common/util/Util;->crc16UpdateFourBits(II)I
    ...
    .line 2922
    invoke-static {v0, p3}, Lio/bidmachine/media3/common/util/Util;->crc16UpdateFourBits(II)I
...
.method private static crc16UpdateFourBits(II)I
    ...
    .line 2944
    sget-object v1, Lio/bidmachine/media3/common/util/Util;->CRC16_BYTES_MSBF:[I
...
.method public static getMaxPendingFramesCountForMediaCodecDecoders(Landroid/content/Context;)I
    ...
    .line 3503
    invoke-static {p0}, Lio/bidmachine/media3/common/util/Util;->isFrameDropAllowedOnSurfaceInput(Landroid/content/Context;)Z
...
.method public static getPcmFormat(Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;)Lio/bidmachine/media3/common/Format;
    .locals 2

    .line 2184
    iget v0, p0, Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;->encoding:I

    iget v1, p0, Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;->channelCount:I

    iget p0, p0, Lio/bidmachine/media3/common/audio/AudioProcessor$AudioFormat;->sampleRate:I

    invoke-static {v0, v1, p0}, Lio/bidmachine/media3/common/util/Util;->getPcmFormat(III)Lio/bidmachine/media3/common/Format;
...
.method public static getPcmFrameSize(II)I
    ...
    .line 2366
    invoke-static {p0}, Lio/bidmachine/media3/common/util/Util;->getByteDepth(I)I
...
.method public static getUserAgent(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string p1, ") AndroidXMedia3/1.7.1"
...
.method public static handlePlayPauseButtonAction(Lio/bidmachine/media3/common/Player;)Z
    ...
    .line 3734
    invoke-static {p0, v0}, Lio/bidmachine/media3/common/util/Util;->handlePlayPauseButtonAction(Lio/bidmachine/media3/common/Player;Z)Z
...
.method public static handlePlayPauseButtonAction(Lio/bidmachine/media3/common/Player;Z)Z
    .locals 0

    .line 3751
    invoke-static {p0, p1}, Lio/bidmachine/media3/common/util/Util;->shouldShowPlayButton(Lio/bidmachine/media3/common/Player;Z)Z
...
.method public static isFrameDropAllowedOnSurfaceInput(Landroid/content/Context;)Z
    ...
    .line 3492
    invoke-static {p0, v1}, Lcom/google/common/base/Ascii;->equalsIgnoreCase(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
...
.method private static isReadStoragePermissionRequestNeeded(Landroid/app/Activity;Landroid/net/Uri;)Z
    ...
    .line 394
    invoke-static {p0, p1}, Lio/bidmachine/media3/common/util/Util;->isAppSpecificStorageFileUri(Landroid/app/Activity;Landroid/net/Uri;)Z
...
.method public static maybeInflate(Lio/bidmachine/media3/common/util/ParsableByteArray;Lio/bidmachine/media3/common/util/ParsableByteArray;Ljava/util/zip/Inflater;)Z
    .locals 2
    ...
    .line 3115
    invoke-static {p0, p1, p2}, Lio/bidmachine/media3/common/util/Util;->inflate(Lio/bidmachine/media3/common/util/ParsableByteArray;Lio/bidmachine/media3/common/util/ParsableByteArray;Ljava/util/zip/Inflater;)Z
...
.method public static varargs maybeRequestReadExternalStoragePermission(Landroid/app/Activity;[Landroid/net/Uri;)Z
    ...
    .line 328
    invoke-static {p0, v3}, Lio/bidmachine/media3/common/util/Util;->maybeRequestReadStoragePermission(Landroid/app/Activity;Landroid/net/Uri;)Z
...
.method public static varargs maybeRequestReadExternalStoragePermission(Landroid/app/Activity;[Lio/bidmachine/media3/common/MediaItem;)Z
    ...
    .line 341
    invoke-static {p0, p1}, Lio/bidmachine/media3/common/util/Util;->maybeRequestReadStoragePermission(Landroid/app/Activity;[Lio/bidmachine/media3/common/MediaItem;)Z
...
.method private static maybeRequestReadStoragePermission(Landroid/app/Activity;Landroid/net/Uri;)Z
    ...
    .line 377
    invoke-static {p0, p1}, Lio/bidmachine/media3/common/util/Util;->isReadStoragePermissionRequestNeeded(Landroid/app/Activity;Landroid/net/Uri;)Z
    ...
    .line 383
    :cond_1
    invoke-static {p0}, Lio/bidmachine/media3/common/util/Util;->requestReadMediaPermissions(Landroid/app/Activity;)Z
...
.method public static varargs maybeRequestReadStoragePermission(Landroid/app/Activity;[Lio/bidmachine/media3/common/MediaItem;)Z
    .locals 7
    ...
    invoke-static {p0, v4}, Lio/bidmachine/media3/common/util/Util;->maybeRequestReadStoragePermission(Landroid/app/Activity;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, v6}, Lio/bidmachine/media3/common/util/Util;->maybeRequestReadStoragePermission(Landroid/app/Activity;Landroid/net/Uri;)Z
...
.method public static newSingleThreadExecutor(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    .line 913
    new-instance v0, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0}, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda1;-><init>(Ljava/lang/String;)V
...
.method public static newSingleThreadScheduledExecutor(Ljava/lang/String;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 924
    new-instance v0, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0}, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda0;-><init>(Ljava/lang/String;)V
...
.method public static postOrRunWithCompletion(Landroid/os/Handler;Ljava/lang/Runnable;Ljava/lang/Object;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 823
    new-instance v1, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda2;

    invoke-direct {v1, v0, p1, p2}, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda2;-><init>(Lcom/google/common/util/concurrent/SettableFuture;Ljava/lang/Runnable;Ljava/lang/Object;)V
...
.method public static scaleLargeTimestamps(Ljava/util/List;JJ)[J
    ...
    invoke-static/range {v0 .. v5}, Lio/bidmachine/media3/common/util/Util;->scaleLargeValues(Ljava/util/List;JJLjava/math/RoundingMode;)[J
...
.method public static scaleLargeTimestampsInPlace([JJJ)V
    ...
    invoke-static/range {v0 .. v5}, Lio/bidmachine/media3/common/util/Util;->scaleLargeValuesInPlace([JJJLjava/math/RoundingMode;)V
...
.method public static scaleLargeValue(JJJLjava/math/RoundingMode;)J
    ...
    .line 1751
    invoke-static/range {v0 .. v6}, Lio/bidmachine/media3/common/util/Util;->scaleLargeValueFallback(JJJLjava/math/RoundingMode;)J
...
.method public static scaleLargeValues(Ljava/util/List;JJLjava/math/RoundingMode;)[J
    ...
    .line 1798
    :cond_5
    invoke-static/range {v1 .. v7}, Lio/bidmachine/media3/common/util/Util;->scaleLargeValueFallback(JJJLjava/math/RoundingMode;)J
...
.method public static setForegroundServiceNotification(Landroid/app/Service;ILandroid/app/Notification;ILjava/lang/String;)V
    ...
    .line 311
    invoke-static {p0, p1, p2, p3, p4}, Lio/bidmachine/media3/common/util/Util$Api29;->startForeground(Landroid/app/Service;ILandroid/app/Notification;ILjava/lang/String;)V
...
.method public static shouldEnablePlayPauseButton(Lio/bidmachine/media3/common/Player;)Z
    .locals 2
    ...
    .line 3637
    invoke-interface {p0, v1}, Lio/bidmachine/media3/common/Player;->isCommandAvailable(I)Z
...
.method public static shouldShowPlayButton(Lio/bidmachine/media3/common/Player;)Z
    ...
    .line 3652
    invoke-static {p0, v0}, Lio/bidmachine/media3/common/util/Util;->shouldShowPlayButton(Lio/bidmachine/media3/common/Player;Z)Z
...
.method public static shouldShowPlayButton(Lio/bidmachine/media3/common/Player;Z)Z
    .locals 3
    .annotation runtime Lorg/checkerframework/checker/nullness/qual/EnsuresNonNullIf;
        expression = {
            "#1"
...
.method public static transformFutureAsync(Lcom/google/common/util/concurrent/ListenableFuture;Lcom/google/common/util/concurrent/AsyncFunction;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 862
    new-instance v1, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda3;

    invoke-direct {v1, v0, p0}, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda3;-><init>(Lcom/google/common/util/concurrent/SettableFuture;Lcom/google/common/util/concurrent/ListenableFuture;)V
    ...
    .line 869
    new-instance v1, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda4;

    invoke-direct {v1, p0, v0, p1}, Lio/bidmachine/media3/common/util/Util$$ExternalSyntheticLambda4;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Lcom/google/common/util/concurrent/SettableFuture;Lcom/google/common/util/concurrent/AsyncFunction;)V
