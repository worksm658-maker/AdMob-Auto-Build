...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->FIELD_START_POSITION_US:Ljava/lang/String;
    ...
    sput-object v0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->FIELD_END_POSITION_US:Ljava/lang/String;
...
.method private constructor <init>(Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;)V
    ...
    .line 2002
    invoke-static {p1}, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;->access$4000(Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;)J
    ...
    iput-wide v0, p0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startPositionUs:J
    ...
    iput-wide v0, p0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->endPositionUs:J
    ...
    .line 2007
    invoke-static {p1}, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;->access$4300(Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;)Z
...
.method public static fromBundle(Landroid/os/Bundle;)Lio/bidmachine/media3/common/MediaItem$ClippingProperties;
    .locals 7
    ...
    iget-boolean v3, v2, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startsAtKeyFrame:Z
    ...
    .line 2097
    invoke-virtual {v0, v1}, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;->setStartsAtKeyFrame(Z)Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;

    move-result-object v0

    .line 2100
    sget-object v1, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->FIELD_START_POSITION_US:Ljava/lang/String;

    iget-wide v3, v2, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startPositionUs:J
    ...
    .line 2102
    iget-wide v5, v2, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startPositionUs:J
    ...
    .line 2103
    invoke-virtual {v0, v3, v4}, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;->setStartPositionUs(J)Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;

    .line 2105
    :cond_0
    sget-object v1, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->FIELD_END_POSITION_US:Ljava/lang/String;

    iget-wide v3, v2, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->endPositionUs:J
    ...
    .line 2107
    iget-wide v1, v2, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->endPositionUs:J
    ...
    .line 2108
    invoke-virtual {v0, v3, v4}, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;->setEndPositionUs(J)Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration$Builder;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 2026
    iget-wide v3, p0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startPositionUs:J

    iget-wide v5, p1, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startPositionUs:J

    cmp-long v1, v3, v5

    if-nez v1, :cond_2

    iget-wide v3, p0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->endPositionUs:J

    iget-wide v5, p1, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->endPositionUs:J
...
.method public hashCode()I
    ...
    .line 2035
    iget-wide v0, p0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startPositionUs:J
...
.method public toBundle()Landroid/os/Bundle;
    ...
    .line 2060
    :cond_1
    iget-wide v1, p0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startPositionUs:J

    iget-wide v4, v3, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->startPositionUs:J
    ...
    .line 2061
    sget-object v4, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->FIELD_START_POSITION_US:Ljava/lang/String;

    invoke-virtual {v0, v4, v1, v2}, Landroid/os/Bundle;->putLong(Ljava/lang/String;J)V

    .line 2063
    :cond_2
    iget-wide v1, p0, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->endPositionUs:J

    iget-wide v4, v3, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->endPositionUs:J
    ...
    .line 2064
    sget-object v4, Lio/bidmachine/media3/common/MediaItem$ClippingConfiguration;->FIELD_END_POSITION_US:Ljava/lang/String;
