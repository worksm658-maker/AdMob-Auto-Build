...
.method public static fromBundle(Landroid/os/Bundle;)Lio/bidmachine/media3/common/Player$PositionInfo;
    .locals 14
    ...
    .line 478
    :cond_0
    invoke-static {v0}, Lio/bidmachine/media3/common/MediaItem;->fromBundle(Landroid/os/Bundle;)Lio/bidmachine/media3/common/MediaItem;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 354
    invoke-virtual {p0, p1}, Lio/bidmachine/media3/common/Player$PositionInfo;->equalsForBundling(Lio/bidmachine/media3/common/Player$PositionInfo;)Z
    ...
    iget-object p1, p1, Lio/bidmachine/media3/common/Player$PositionInfo;->periodUid:Ljava/lang/Object;
...
.method public equalsForBundling(Lio/bidmachine/media3/common/Player$PositionInfo;)Z
    .locals 4

    .line 379
    iget v0, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->mediaItemIndex:I

    iget v1, p1, Lio/bidmachine/media3/common/Player$PositionInfo;->mediaItemIndex:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->periodIndex:I

    iget v1, p1, Lio/bidmachine/media3/common/Player$PositionInfo;->periodIndex:I

    if-ne v0, v1, :cond_0

    iget-wide v0, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->positionMs:J

    iget-wide v2, p1, Lio/bidmachine/media3/common/Player$PositionInfo;->positionMs:J

    cmp-long v0, v0, v2

    if-nez v0, :cond_0

    iget-wide v0, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->contentPositionMs:J
    ...
    iget v0, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->adGroupIndex:I

    iget v1, p1, Lio/bidmachine/media3/common/Player$PositionInfo;->adGroupIndex:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->adIndexInAdGroup:I

    iget v1, p1, Lio/bidmachine/media3/common/Player$PositionInfo;->adIndexInAdGroup:I

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->mediaItem:Lio/bidmachine/media3/common/MediaItem;
...
.method public filterByAvailableCommands(ZZ)Lio/bidmachine/media3/common/Player$PositionInfo;
    .locals 14
    ...
    iget-object v1, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->windowUid:Ljava/lang/Object;
    ...
    .line 417
    iget-object v4, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->mediaItem:Lio/bidmachine/media3/common/MediaItem;
    ...
    :goto_1
    iget-object v5, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->periodUid:Ljava/lang/Object;
    ...
    .line 420
    iget-wide v8, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->positionMs:J
    ...
    .line 422
    iget v11, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->adGroupIndex:I
    ...
    .line 423
    iget v10, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->adIndexInAdGroup:I
...
.method public toBundle()Landroid/os/Bundle;
    ...
    .line 469
    invoke-virtual {p0, v0}, Lio/bidmachine/media3/common/Player$PositionInfo;->toBundle(I)Landroid/os/Bundle;
...
.method public toBundle(I)Landroid/os/Bundle;
    ...
    .line 440
    :cond_0
    sget-object v2, Lio/bidmachine/media3/common/Player$PositionInfo;->FIELD_MEDIA_ITEM_INDEX:Ljava/lang/String;
    ...
    .line 446
    :cond_3
    sget-object v2, Lio/bidmachine/media3/common/Player$PositionInfo;->FIELD_PERIOD_INDEX:Ljava/lang/String;

    iget v3, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->periodIndex:I
    ...
    .line 448
    iget-wide v4, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->positionMs:J
    ...
    .line 449
    :cond_5
    sget-object v4, Lio/bidmachine/media3/common/Player$PositionInfo;->FIELD_POSITION_MS:Ljava/lang/String;
    ...
    .line 451
    iget-wide v4, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->contentPositionMs:J
    ...
    .line 452
    :cond_7
    sget-object p1, Lio/bidmachine/media3/common/Player$PositionInfo;->FIELD_CONTENT_POSITION_MS:Ljava/lang/String;
    ...
    .line 454
    :cond_8
    iget p1, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->adGroupIndex:I
    ...
    .line 455
    sget-object v2, Lio/bidmachine/media3/common/Player$PositionInfo;->FIELD_AD_GROUP_INDEX:Ljava/lang/String;

    invoke-virtual {v0, v2, p1}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    .line 457
    :cond_9
    iget p1, p0, Lio/bidmachine/media3/common/Player$PositionInfo;->adIndexInAdGroup:I

    if-eq p1, v1, :cond_a

    .line 458
    sget-object v1, Lio/bidmachine/media3/common/Player$PositionInfo;->FIELD_AD_INDEX_IN_AD_GROUP:Ljava/lang/String;
