...
.method public write(Lorg/cocos2dx/okio/Buffer;J)V
    ...
    :cond_1
    :goto_2
    iget-object v2, p0, Lorg/cocos2dx/okio/AsyncTimeout$1;->this$0:Lorg/cocos2dx/okio/AsyncTimeout;

    invoke-virtual {v2}, Lorg/cocos2dx/okio/AsyncTimeout;->enter()V

    .line 180
    :try_start_0
    iget-object v2, p0, Lorg/cocos2dx/okio/AsyncTimeout$1;->val$sink:Lorg/cocos2dx/okio/Sink;

    invoke-interface {v2, p1, v0, v1}, Lorg/cocos2dx/okio/Sink;->write(Lorg/cocos2dx/okio/Buffer;J)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
