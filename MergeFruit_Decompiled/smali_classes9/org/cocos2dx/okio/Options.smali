...
.method private static buildTrieRecursive(JLorg/cocos2dx/okio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    check-cast v6, Lorg/cocos2dx/okio/ByteString;
    ...
    check-cast v9, Lorg/cocos2dx/okio/ByteString;

    invoke-virtual {v9, v1}, Lorg/cocos2dx/okio/ByteString;->getByte(I)B
    ...
    .line 162
    :cond_7
    new-instance v4, Lorg/cocos2dx/okio/Buffer;

    invoke-direct {v4}, Lorg/cocos2dx/okio/Buffer;-><init>()V
    ...
    .line 180
    :cond_a
    invoke-static {v4}, Lorg/cocos2dx/okio/Options;->intCount(Lorg/cocos2dx/okio/Buffer;)I
    ...
    invoke-virtual {v0, v4, v1, v2}, Lorg/cocos2dx/okio/Buffer;->write(Lorg/cocos2dx/okio/Buffer;J)V
    ...
    .line 200
    invoke-virtual {v3, v11}, Lorg/cocos2dx/okio/ByteString;->getByte(I)B

    move-result v12

    move-wide/from16 v17, v13

    invoke-virtual {v4, v11}, Lorg/cocos2dx/okio/ByteString;->getByte(I)B
    ...
    .line 214
    invoke-virtual {v3, v2}, Lorg/cocos2dx/okio/ByteString;->getByte(I)B
    ...
    .line 226
    invoke-static {v3}, Lorg/cocos2dx/okio/Options;->intCount(Lorg/cocos2dx/okio/Buffer;)I
...
.method public static varargs of([Lorg/cocos2dx/okio/ByteString;)Lorg/cocos2dx/okio/Options;
    ...
    new-array v0, v2, [Lorg/cocos2dx/okio/ByteString;
    ...
    .line 64
    invoke-virtual {v5, v1}, Lorg/cocos2dx/okio/ByteString;->startsWith(Lorg/cocos2dx/okio/ByteString;)Z
    ...
    invoke-static/range {v3 .. v10}, Lorg/cocos2dx/okio/Options;->buildTrieRecursive(JLorg/cocos2dx/okio/Buffer;ILjava/util/List;IILjava/util/List;)V

    .line 80
    invoke-static {v5}, Lorg/cocos2dx/okio/Options;->intCount(Lorg/cocos2dx/okio/Buffer;)I
    ...
    .line 82
    invoke-virtual {v5}, Lorg/cocos2dx/okio/Buffer;->readInt()I
    ...
    .line 84
    :cond_8
    invoke-virtual {v5}, Lorg/cocos2dx/okio/Buffer;->exhausted()Z
    ...
    invoke-direct {v0, p0, v1}, Lorg/cocos2dx/okio/Options;-><init>([Lorg/cocos2dx/okio/ByteString;[I)V
