...
.method public connect(IIIIZLorg/cocos2dx/okhttp3/Call;Lorg/cocos2dx/okhttp3/EventListener;)V
    ...
    .line 139
    new-instance v7, Lorg/cocos2dx/okhttp3/internal/connection/ConnectionSpecSelector;

    invoke-direct {v7, v0}, Lorg/cocos2dx/okhttp3/internal/connection/ConnectionSpecSelector;-><init>(Ljava/util/List;)V
    ...
    .line 148
    :cond_0
    new-instance p1, Lorg/cocos2dx/okhttp3/internal/connection/RouteException;
    ...
    invoke-direct {p1, p2}, Lorg/cocos2dx/okhttp3/internal/connection/RouteException;-><init>(Ljava/io/IOException;)V
    ...
    .line 167
    invoke-direct {p0, p1, p2, v2, v1}, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->connectSocket(IILorg/cocos2dx/okhttp3/Call;Lorg/cocos2dx/okhttp3/EventListener;)V
    :try_end_2
    ...
    .line 169
    :try_start_3
    invoke-direct {p0, v7, v11, v2, v1}, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->establishProtocol(Lorg/cocos2dx/okhttp3/internal/connection/ConnectionSpecSelector;ILorg/cocos2dx/okhttp3/Call;Lorg/cocos2dx/okhttp3/EventListener;)V
    ...
    invoke-virtual {v3}, Lorg/cocos2dx/okhttp3/Route;->proxy()Ljava/net/Proxy;

    move-result-object v3

    iget-object v4, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->protocol:Lorg/cocos2dx/okhttp3/Protocol;

    invoke-virtual {v1, v2, v0, v3, v4}, Lorg/cocos2dx/okhttp3/EventListener;->connectEnd(Lorg/cocos2dx/okhttp3/Call;Ljava/net/InetSocketAddress;Ljava/net/Proxy;Lorg/cocos2dx/okhttp3/Protocol;)V
    :try_end_3
    ...
    invoke-virtual {p1}, Lorg/cocos2dx/okhttp3/Route;->requiresTunnel()Z
    ...
    .line 204
    iget-object p1, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->connectionPool:Lorg/cocos2dx/okhttp3/ConnectionPool;

    monitor-enter p1

    .line 205
    :try_start_4
    iget-object p2, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->http2Connection:Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;

    invoke-virtual {p2}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->maxConcurrentStreams()I

    move-result p2

    iput p2, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->allocationLimit:I
    ...
    .line 175
    iput-object v8, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->socket:Ljava/net/Socket;

    .line 176
    iput-object v8, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    .line 177
    iput-object v8, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->source:Lorg/cocos2dx/okio/BufferedSource;

    .line 178
    iput-object v8, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->sink:Lorg/cocos2dx/okio/BufferedSink;

    .line 179
    iput-object v8, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->handshake:Lorg/cocos2dx/okhttp3/Handshake;

    .line 180
    iput-object v8, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->protocol:Lorg/cocos2dx/okhttp3/Protocol;

    .line 181
    iput-object v8, p0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection;->http2Connection:Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;
    ...
    .line 186
    new-instance v9, Lorg/cocos2dx/okhttp3/internal/connection/RouteException;

    invoke-direct {v9, v6}, Lorg/cocos2dx/okhttp3/internal/connection/RouteException;-><init>(Ljava/io/IOException;)V

    goto :goto_7

    .line 188
    :cond_8
    invoke-virtual {v9, v6}, Lorg/cocos2dx/okhttp3/internal/connection/RouteException;->addConnectException(Ljava/io/IOException;)V

    :goto_7
    if-eqz p5, :cond_9

    .line 191
    invoke-virtual {v7, v6}, Lorg/cocos2dx/okhttp3/internal/connection/ConnectionSpecSelector;->connectionFailed(Ljava/io/IOException;)Z
...
.method public newWebSocketStreams(Lorg/cocos2dx/okhttp3/internal/connection/StreamAllocation;)Lorg/cocos2dx/okhttp3/internal/ws/RealWebSocket$Streams;
    ...
    .line 534
    new-instance v0, Lorg/cocos2dx/okhttp3/internal/connection/RealConnection$1;
