...
.method static constructor <clinit>()V
    ...
    .line 134
    new-instance v0, Lorg/cocos2dx/okhttp3/OkHttpClient$1;

    invoke-direct {v0}, Lorg/cocos2dx/okhttp3/OkHttpClient$1;-><init>()V
...
.method constructor <init>(Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;)V
    ...
    .line 239
    iget-object v1, p1, Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;->interceptors:Ljava/util/List;

    invoke-static {v1}, Lorg/cocos2dx/okhttp3/internal/Util;->immutableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->interceptors:Ljava/util/List;

    .line 240
    iget-object v1, p1, Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;->networkInterceptors:Ljava/util/List;

    invoke-static {v1}, Lorg/cocos2dx/okhttp3/internal/Util;->immutableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->networkInterceptors:Ljava/util/List;

    .line 241
    iget-object v1, p1, Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;->eventListenerFactory:Lorg/cocos2dx/okhttp3/EventListener$Factory;

    iput-object v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->eventListenerFactory:Lorg/cocos2dx/okhttp3/EventListener$Factory;

    .line 242
    iget-object v1, p1, Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;->proxySelector:Ljava/net/ProxySelector;

    iput-object v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->proxySelector:Ljava/net/ProxySelector;

    .line 243
    iget-object v1, p1, Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;->cookieJar:Lorg/cocos2dx/okhttp3/CookieJar;

    iput-object v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->cookieJar:Lorg/cocos2dx/okhttp3/CookieJar;

    .line 244
    iget-object v1, p1, Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;->cache:Lorg/cocos2dx/okhttp3/Cache;

    iput-object v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->cache:Lorg/cocos2dx/okhttp3/Cache;

    .line 245
    iget-object v1, p1, Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;->internalCache:Lorg/cocos2dx/okhttp3/internal/cache/InternalCache;

    iput-object v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->internalCache:Lorg/cocos2dx/okhttp3/internal/cache/InternalCache;

    .line 246
    iget-object v1, p1, Lorg/cocos2dx/okhttp3/OkHttpClient$Builder;->socketFactory:Ljavax/net/SocketFactory;

    iput-object v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->socketFactory:Ljavax/net/SocketFactory;
...
.method public newCall(Lorg/cocos2dx/okhttp3/Request;)Lorg/cocos2dx/okhttp3/Call;
    ...
    .line 427
    invoke-static {p0, p1, v0}, Lorg/cocos2dx/okhttp3/RealCall;->newRealCall(Lorg/cocos2dx/okhttp3/OkHttpClient;Lorg/cocos2dx/okhttp3/Request;Z)Lorg/cocos2dx/okhttp3/RealCall;
...
.method public newWebSocket(Lorg/cocos2dx/okhttp3/Request;Lorg/cocos2dx/okhttp3/WebSocketListener;)Lorg/cocos2dx/okhttp3/WebSocket;
    ...
    .line 434
    new-instance v0, Lorg/cocos2dx/okhttp3/internal/ws/RealWebSocket;

    new-instance v3, Ljava/util/Random;

    invoke-direct {v3}, Ljava/util/Random;-><init>()V

    iget v1, p0, Lorg/cocos2dx/okhttp3/OkHttpClient;->pingInterval:I
    ...
    .line 435
    invoke-virtual {v0, p0}, Lorg/cocos2dx/okhttp3/internal/ws/RealWebSocket;->connect(Lorg/cocos2dx/okhttp3/OkHttpClient;)V
