...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/mbridge/msdk/foundation/same/task/a$b;

    const-string v2, "RUNNING"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/mbridge/msdk/foundation/same/task/a$b;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/mbridge/msdk/foundation/same/task/a$b;->b:Lcom/mbridge/msdk/foundation/same/task/a$b;

    new-instance v2, Lcom/mbridge/msdk/foundation/same/task/a$b;

    const-string v3, "PAUSE"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/mbridge/msdk/foundation/same/task/a$b;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/mbridge/msdk/foundation/same/task/a$b;->c:Lcom/mbridge/msdk/foundation/same/task/a$b;

    new-instance v3, Lcom/mbridge/msdk/foundation/same/task/a$b;

    const-string v4, "CANCEL"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/mbridge/msdk/foundation/same/task/a$b;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/mbridge/msdk/foundation/same/task/a$b;->d:Lcom/mbridge/msdk/foundation/same/task/a$b;

    new-instance v4, Lcom/mbridge/msdk/foundation/same/task/a$b;

    const-string v5, "FINISH"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/mbridge/msdk/foundation/same/task/a$b;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/mbridge/msdk/foundation/same/task/a$b;->e:Lcom/mbridge/msdk/foundation/same/task/a$b;

    .line 2
    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/mbridge/msdk/foundation/same/task/a$b;
