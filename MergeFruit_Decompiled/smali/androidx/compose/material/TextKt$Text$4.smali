...
.method constructor <init>(Landroidx/compose/ui/text/AnnotatedString;Landroidx/compose/ui/Modifier;JJLandroidx/compose/ui/text/font/FontStyle;Landroidx/compose/ui/text/font/FontWeight;Landroidx/compose/ui/text/font/FontFamily;JLandroidx/compose/ui/text/style/TextDecoration;Landroidx/compose/ui/text/style/TextAlign;JIZILjava/util/Map;Lkotlin/jvm/functions/Function1;Landroidx/compose/ui/text/TextStyle;III)V
    ...
    iput-object p1, p0, Landroidx/compose/material/TextKt$Text$4;->$text:Landroidx/compose/ui/text/AnnotatedString;

    iput-object p2, p0, Landroidx/compose/material/TextKt$Text$4;->$modifier:Landroidx/compose/ui/Modifier;

    iput-wide p3, p0, Landroidx/compose/material/TextKt$Text$4;->$color:J

    iput-wide p5, p0, Landroidx/compose/material/TextKt$Text$4;->$fontSize:J

    iput-object p7, p0, Landroidx/compose/material/TextKt$Text$4;->$fontStyle:Landroidx/compose/ui/text/font/FontStyle;

    iput-object p8, p0, Landroidx/compose/material/TextKt$Text$4;->$fontWeight:Landroidx/compose/ui/text/font/FontWeight;

    iput-object p9, p0, Landroidx/compose/material/TextKt$Text$4;->$fontFamily:Landroidx/compose/ui/text/font/FontFamily;

    iput-wide p10, p0, Landroidx/compose/material/TextKt$Text$4;->$letterSpacing:J

    iput-object p12, p0, Landroidx/compose/material/TextKt$Text$4;->$textDecoration:Landroidx/compose/ui/text/style/TextDecoration;

    iput-object p13, p0, Landroidx/compose/material/TextKt$Text$4;->$textAlign:Landroidx/compose/ui/text/style/TextAlign;

    iput-wide p14, p0, Landroidx/compose/material/TextKt$Text$4;->$lineHeight:J

    move/from16 p1, p16

    iput p1, p0, Landroidx/compose/material/TextKt$Text$4;->$overflow:I

    move/from16 p1, p17

    iput-boolean p1, p0, Landroidx/compose/material/TextKt$Text$4;->$softWrap:Z

    move/from16 p1, p18

    iput p1, p0, Landroidx/compose/material/TextKt$Text$4;->$maxLines:I

    move-object/from16 p1, p19

    iput-object p1, p0, Landroidx/compose/material/TextKt$Text$4;->$inlineContent:Ljava/util/Map;

    move-object/from16 p1, p20

    iput-object p1, p0, Landroidx/compose/material/TextKt$Text$4;->$onTextLayout:Lkotlin/jvm/functions/Function1;

    move-object/from16 p1, p21

    iput-object p1, p0, Landroidx/compose/material/TextKt$Text$4;->$style:Landroidx/compose/ui/text/TextStyle;

    move/from16 p1, p22

    iput p1, p0, Landroidx/compose/material/TextKt$Text$4;->$$changed:I

    move/from16 p1, p23

    iput p1, p0, Landroidx/compose/material/TextKt$Text$4;->$$changed1:I

    move/from16 p1, p24

    iput p1, p0, Landroidx/compose/material/TextKt$Text$4;->$$default:I
