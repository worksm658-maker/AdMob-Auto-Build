...
.method public run()V
    ...
    .line 56
    .line 57
    invoke-interface {v2}, Lcom/unity3d/services/core/webview/bridge/invocation/IWebViewBridgeInvocationCallback;->onSuccess()V
    ...
    .line 61
    :cond_2
    const-string v0, "WebViewBridgeInvocationRunnable:run CallbackStatus.Error"
    ...
    .line 64
    .line 65
    invoke-interface {v2, v0, v1}, Lcom/unity3d/services/core/webview/bridge/invocation/IWebViewBridgeInvocationCallback;->onFailure(Ljava/lang/String;Lcom/unity3d/services/core/webview/bridge/CallbackStatus;)V
