...
.field public final synthetic b:Landroidx/media3/datasource/HttpEngineDataSource;
...
.method public constructor <init>(Landroidx/media3/datasource/HttpEngineDataSource;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Landroidx/media3/datasource/a;->b:Landroidx/media3/datasource/HttpEngineDataSource;
...
# virtual methods
.method public final declared-synchronized onCanceled(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;)V
    .locals 0
...
.method public final declared-synchronized onFailed(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    .locals 0
    ...
    .line 2
    :try_start_0
    iget-boolean p1, p0, Landroidx/media3/datasource/a;->a:Z
    :try_end_0
    ...
    :cond_0
    :try_start_1
    invoke-static {p3}, Lf0/g;->y(Ljava/lang/Object;)Z
    ...
    .line 13
    .line 14
    invoke-static {p3}, Lf0/g;->l(Ljava/lang/Object;)Landroid/net/http/NetworkException;
    ...
    .line 18
    invoke-static {p1}, Lf0/g;->a(Landroid/net/http/NetworkException;)I
    ...
    .line 24
    .line 25
    iget-object p1, p0, Landroidx/media3/datasource/a;->b:Landroidx/media3/datasource/HttpEngineDataSource;
...
.method public final declared-synchronized onReadCompleted(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/nio/ByteBuffer;)V
    .locals 0
...
.method public final declared-synchronized onRedirectReceived(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/lang/String;)V
    .locals 8
    ...
    .line 2
    :try_start_0
    iget-boolean v0, p0, Landroidx/media3/datasource/a;->a:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Landroidx/media3/datasource/a;->b:Landroidx/media3/datasource/HttpEngineDataSource;
    ...
    .line 20
    .line 21
    invoke-static {p2}, Lcom/google/android/gms/internal/ads/c;->a(Landroid/net/http/UrlResponseInfo;)I
    ...
    .line 41
    .line 42
    invoke-static {p2}, Lcom/google/android/gms/internal/ads/c;->m(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
    ...
    .line 46
    invoke-static {p2}, Lcom/google/android/gms/internal/ads/c;->e(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;
    ...
    .line 50
    invoke-static {p2}, Lcom/google/android/gms/internal/ads/c;->o(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    .line 112
    .line 113
    iget-object v2, p0, Landroidx/media3/datasource/a;->b:Landroidx/media3/datasource/HttpEngineDataSource;
    ...
    .line 120
    .line 121
    invoke-static {p1}, Lf0/g;->s(Landroid/net/http/UrlRequest;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    :cond_6
    :try_start_4
    invoke-static {p1}, Lf0/g;->B(Landroid/net/http/UrlRequest;)V
    ...
    :cond_8
    :try_start_5
    iget-object p2, p0, Landroidx/media3/datasource/a;->b:Landroidx/media3/datasource/HttpEngineDataSource;

    .line 232
    .line 233
    invoke-static {p2, p1}, Landroidx/media3/datasource/HttpEngineDataSource;->access$900(Landroidx/media3/datasource/HttpEngineDataSource;Landroidx/media3/datasource/DataSpec;)Lf0/i;
    ...
    .line 238
    .line 239
    invoke-static {p2}, Landroidx/media3/datasource/HttpEngineDataSource;->access$1000(Landroidx/media3/datasource/HttpEngineDataSource;)Lf0/i;
    ...
    .line 251
    iget-object p3, p2, Lf0/i;->b:Landroidx/media3/datasource/a;

    .line 252
    .line 253
    iput-boolean v3, p3, Landroidx/media3/datasource/a;->a:Z

    .line 254
    .line 255
    iget-object p2, p2, Lf0/i;->a:Landroid/net/http/UrlRequest;

    .line 256
    .line 257
    invoke-static {p2}, Lf0/g;->B(Landroid/net/http/UrlRequest;)V
    ...
    .line 261
    .line 262
    invoke-static {p2, p1}, Landroidx/media3/datasource/HttpEngineDataSource;->access$1002(Landroidx/media3/datasource/HttpEngineDataSource;Lf0/i;)Lf0/i;
    ...
    .line 266
    .line 267
    invoke-static {p1}, Landroidx/media3/datasource/HttpEngineDataSource;->access$1000(Landroidx/media3/datasource/HttpEngineDataSource;)Lf0/i;
    ...
    .line 271
    iget-object p1, p1, Lf0/i;->a:Landroid/net/http/UrlRequest;

    .line 272
    .line 273
    invoke-static {p1}, Lf0/g;->D(Landroid/net/http/UrlRequest;)V
    :try_end_6
...
.method public final declared-synchronized onResponseStarted(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;)V
    .locals 0
...
.method public final declared-synchronized onSucceeded(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;)V
    .locals 0
